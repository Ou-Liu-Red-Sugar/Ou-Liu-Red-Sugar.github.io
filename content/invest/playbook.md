...
The current architecture has three connected layers. A fuller public summary is available in **[Framework](/invest/framework/)**.
...
The older [Log](/invest/log/), [Lessons](/invest/lessons/), and [Monthly Reviews](/invest/reviews/) are retained as historical records. They may reflect earlier versions of the framework, including rules and assumptions that are no longer current. They should be read as dated evidence of iteration, not as presently binding instructions.
