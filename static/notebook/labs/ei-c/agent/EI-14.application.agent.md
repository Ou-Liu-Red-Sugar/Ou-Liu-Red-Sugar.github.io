...
```json
{
  ...
  "required_readings": [
    ...
    },
    {
      ...
      "required_unit": {
        "locator": "HBS 24-012，2023-08-30；§2 印刷 p.5 / PDF 8；§4.4 印刷 pp.26–30 / PDF 29–33，含 Figures 11–13 及图注.",
        "scope": "数据版本及间接贸易/投资联系的完整采用单元；Table3计算留研究分支",
        "purpose": "说明直接原产、投入采购、增加值和所有权为何需要不同资料"
      },
...
先读表的组成. Census 两张年表都列出口、进口和差额，本篇只摘取 **Imports** 的年度 TOTAL. 下面中国行的分母不是中美双边贸易，也不是美国 GDP，而是同年美国从世界进口的商品总额. 两者同为**名义 M 美元、未季调**；不是设备数量或实际产量.
...
[^china]: EIC-S05. U.S. Census Bureau，*Trade in Goods with China*，2017/2022年度TOTAL的Imports列；名义 M 美元、未季调. 读取与冻结日期2026-09-21. https://www.census.gov/foreign-trade/balance/c5700.html
...
2017中国/世界=505165.1/2339591.3，份额21.592023%；2022为536268.7/3239732.9，份额16.552868%. 中国金额+6.157116%，世界+38.474310%，份额-5.039156个百分点. 教学100出口/40采购给40%采购比，VA/所有权未知.

**边界：**真实年表不可编辑；不取网页新年份代替冻结窗口.；教学金额0..200有限数；出口0比率null；采购/出口可大于100%，但不称份额或VA.；Census aggregate不可当作UN Comtrade HS4回归输入.
...
[
  {
    ...
    "description": "同口径历史金额和份额，加上同批次采购链的应用视角.",
    "inputs": {
    ...
    "outputs": {
      ...
      "scope": "trade/composition; application"
    },
    "boundaries": [
...
[
  {
    ...
    "reason": "跨境生产、贸易与布局归入行业环境."
  },
  {
    "from": "EI-14#ei14-network",
    "relation": "requires",
    "to": "EI-05",
