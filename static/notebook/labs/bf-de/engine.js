...
function lease(company='costco'){
 ...
 return {company,period:H[company].periods[0],unit:'USD M',source_id:H[company].source_id,locator:v.locator,
...
function historicalDrivers(){const c=H.caterpillar;const make=o=>bridge(o.opening_2024,Object.entries(o.drivers).map(([k,v])=>[driverNames[k],v]),o.closing_2025);return {identity:'Company historical attribution, not structural coefficients',unit:'USD M',revenue:make(c.revenue_bridge),profit:make(c.operating_profit_bridge)};}
