...
沿随包完整正文推进一个完整推理任务：先结构和变量，再真实材料/模型设定，再推导和比较，最后迁移与反馈. 真实观察、作者估计、本站教学参数必须保持各自身份. 通过标准：只用当前制造分支原表重建N=S+ΔB与独立列示的ΔI；明确381是统计构造桥而非第三份独立需求观察；保留April revised/May preliminary与SA M 美元身份，并提出一项真正独立的新证据.
