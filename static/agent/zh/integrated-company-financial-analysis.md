...
Entry: zh-bf22 | Node: BF-22 | Language: zh | Editorial revision: 2026-09-22

## Teaching instructions
你教授 BF-22《企业财报综合分析与迁移》，版本2026-09-22-deep-review，面向有微积分、线性代数与基本概率基础的高年级本科至研究生. 默认 retail，可选 bank；all 才读取两支主线. Walmart、SVB 与 research 仅在对应扩展启用后读取 optional_readings.
开始实质讲解前，先实际打开 common 与所选分支 required_readings，读完 required_unit 的正文、表和脚注；记录标题、版本、定位和关键设定到从空数组开始的 runtime_reading_log. 正式入口失败时先找同版本正式等价原文；仍缺则标明单元并停止依赖该材料的讲解.
retail：完成 Costco 六字段分析，恢复 OI10,383 与现金14,161，区分期末/加权股数和893/963两种资金口径，并提出两项可证伪库存解释. bank：完成 JPM 分析，恢复税前72,595、现金343,338和普通股权益342,393，用CIB存款增119,826说明为什么要继续看账户类型、平均余额与资金行为.
通过尺度：所有数字可回到原表；事实、解释和待观察项分开；迁移到 Walmart/SVB 时重建期间、主体与计量条件. research 启用时保留 Dechow 2024Q2 pilot 的18家公司选样和编码限制.
...
## Supplied entry
企业财报分析连接经营活动、资源义务、利润、现金与普通股所得，再用新增证据区分尚未确定的解释. Costco 与 JPM 展示零售和银行的不同读法，Walmart 与 SVB 用于迁移练习. 材料截至2026-09-21，各项数字沿原件报告期间.
...
利润表归集期间经营结果，资产负债表记录时点资源与义务，现金流量表记录收付和现金余额变化，权益表记录股东投入、分配及其他变动. 附注展开计量，MD&A将变动联系到业务. [^map]
...
Costco Wholesale Corporation合并集团，FY2025截至2025-08-31，比较期截至2024-09-01，均为52周. 金额单位USD M，利润表股数为K股，资产负债表股数说明为实际股数. [^cost]
...
金额单位：USD M；EPS：USD/股；股数：K股. MD&A p27定义 Gross Margin＝Net sales−Merchandise costs，2025、2024、2023分别为30,026、27,267、25,124. FY2023为53周.
...
| Preferred stock <span class="tex2jax_ignore">&#36;0.005</span> par value; 100,000,000 shares authorized; no shares issued and outstanding | 优先股：每股面值0.005美元；授权100,000,000股；无已发行及流通股 | — | — |
| Common stock <span class="tex2jax_ignore">&#36;0.005</span> par value; 900,000,000 shares authorized; 443,237,000 and 443,126,000 shares issued and outstanding | 普通股：每股面值0.005美元；授权900,000,000股；两期已发行及流通443,237,000及443,126,000股 | 2 | 2 |
...
单位：USD M；股数和面值按行标注，括号为减项，空白表示无金额披露.
...
单位：USD M. 现金集合为 cash and cash equivalents. 补充披露的未付资本支出为非现金项目.

</details>

### 商品、会员与利润形成

在原表定位净销售、会员费、商品成本、存货、应付和门店资源. 商品、仓库、物业设备及租赁使用权共同支持会员仓储零售；采购、供应商付款与销售之间形成时间差. 会员费则按一年会员期递延确认. [^costpolicy]

净销售269,912−商品成本239,886＝毛利30,026；加会员费5,323−销售及管理等费用24,966＝经营利润10,383. 再扣利息154、加利息及其他净收入589＝税前利润10,818，扣税2,719＝净利润8,099. [^costincome]

两期毛利由27,267增至30,026，增加2,759；会员费增加495；销售及管理等费用增加2,156. 经营利润因此增加2,759＋495−2,156＝1,098，与10,383−9,285相等. 毛利变化仍需销量、价格、商品组合与采购成本进一步分解.

存货18,116比前期少531，应付19,783比前期多362，两行余额之差由−774变为−1,667，反向变化893. 现金流对应调整为559＋404＝963，与余额变化差70，尚缺完整归因. [^costcash]

现金余额由9,906＋13,335−5,311−3,775＋6＝14,161闭合. CFO 13,335减物业设备付款5,498，差额7,837；其他资金用途还包括股息2,183、回购903、股权奖励代扣款、债务及融资租赁收付.

### 普通股与权益变动

期末资产77,099＝负债47,935＋权益29,164，优先股未发行. 普通股由443,126,000股增至443,237,000股，净增111,000股. 当年回购与发行、奖励等股份变化合计决定期末股数. [^costequity]

基本 EPS 按443,985 K股年度加权平均股数计算，稀释 EPS 按444,803 K股计算. 权益由23,622增至29,164，增加5,542；净利润8,099与股东分配及其他权益变动共同形成该变化.
...
若库存下降由销售加快解释，应观察到相应销量、交付或周转变化；销量未变而期末采购减少则支持另一机制. 若应付增长由结算推迟解释，应观察到付款日或条款延后；支付节奏未变而采购结构改变，则削弱延付解释.

</details>

<details data-agent-option="walmart"><summary>同业迁移：Walmart FY2026</summary>
<a id="bf22-walmart"></a>

Walmart 有 Walmart U.S.、Walmart International 和 Sam’s Club U.S. 三个报告分部. 美国和加拿大财年截至1月31日，其他经营通常按自然年、滞后一个月合并. 美国库存主要用零售库存法及 LIFO，国际业务按业态使用零售库存法或加权平均并采用 FIFO，Sam’s Club 多数为加权平均及 LIFO. [^wmtpolicy]

FY2026净销售706,413＋会员及其他收入6,750＝收入713,163，经营利润29,825. 资金与资本投入如下. [^wmt]
...
单位：USD M. 物业设备付款已包含在投资现金流中. 公司 FCF 定义为 CFO 减物业设备付款，债务服务、其他合同付款及收购在此定义之外.
...
<strong>解析.</strong> 按三个报告分部定位业务，资源包括门店、供应链与技术. 收入713,163、经营利润29,825；CFO 41,565−物业设备付款26,642＝FCF 14,923. 美国资本支出16,468＋5,571＋1,406＝23,445，再加国际3,197＝26,642. 公司将投入与全渠道、自动化策略联系；交付效率、成本及客户使用变化可进一步检验这些投入的效果. [^wmt]

比较 Costco 与 Walmart 的毛利或周转时，需要统一会员及其他收入、库存计量、期间和业务组合；客户应收周转还需分离对应客户与销售范围.
...
JPMorgan Chase & Co.集团，FY2025截至2025-12-31. 金额单位USD M，利润表加权股数为M股，资产负债表股数说明为实际股数. 贷款、证券、支付、客户资产服务及融资构成分析对象. [^jpm]
...
单位：USD M；EPS：USD/股；股数：M股. 采用集团 GAAP 口径，费用列正额并在计算时扣除，投资证券损失列负收入.
...
| Federal funds sold and securities purchased under resale agreements (included <span class="tex2jax_ignore">&#36;327,018</span> and <span class="tex2jax_ignore">&#36;286,771</span> at fair value) | 拆出联邦基金及买入返售证券〔其中按公允价值计量327,018／286,771〕 | 336,426 | 295,001 |
| Securities borrowed (included <span class="tex2jax_ignore">&#36;98,111</span> and <span class="tex2jax_ignore">&#36;83,962</span> at fair value) | 借入证券〔其中按公允价值计量98,111／83,962〕 | 286,191 | 219,546 |
| Trading assets (included assets pledged of <span class="tex2jax_ignore">&#36;165,927</span> and <span class="tex2jax_ignore">&#36;136,070</span>) | 交易资产〔其中已质押资产165,927／136,070〕 | 802,873 | 637,784 |
| Available-for-sale securities (amortized cost of <span class="tex2jax_ignore">&#36;507,226</span> and <span class="tex2jax_ignore">&#36;411,045</span>; included assets pledged of <span class="tex2jax_ignore">&#36;7,735</span> and <span class="tex2jax_ignore">&#36;10,162</span>) | 可供出售证券〔摊余成本507,226／411,045；其中已质押7,735／10,162〕 | 507,198 | 406,852 |
...
| Loans (included <span class="tex2jax_ignore">&#36;70,684</span> and <span class="tex2jax_ignore">&#36;41,350</span> at fair value) | 贷款，未扣贷款损失准备〔其中按公允价值计量70,684／41,350〕 | 1,493,429 | 1,347,988 |
...
| Other assets (included <span class="tex2jax_ignore">&#36;15,849</span> and <span class="tex2jax_ignore">&#36;15,122</span> at fair value and assets pledged of <span class="tex2jax_ignore">&#36;11,984</span> and <span class="tex2jax_ignore">&#36;6,288</span>) | 其他资产〔其中按公允价值计量15,849／15,122；已质押11,984／6,288〕 | 198,775 | 178,197 |
...
| Deposits (included <span class="tex2jax_ignore">&#36;20,930</span> and <span class="tex2jax_ignore">&#36;33,768</span> at fair value) | 客户存款〔其中按公允价值计量20,930／33,768〕 | 2,559,320 | 2,406,032 |
| Federal funds purchased and securities loaned or sold under repurchase agreements (included <span class="tex2jax_ignore">&#36;360,194</span> and <span class="tex2jax_ignore">&#36;226,329</span> at fair value) | 拆入联邦基金及证券借出或回购融资〔其中按公允价值计量360,194／226,329〕 | 442,396 | 296,835 |
| Short-term borrowings (included <span class="tex2jax_ignore">&#36;32,460</span> and <span class="tex2jax_ignore">&#36;26,521</span> at fair value) | 短期借款〔其中按公允价值计量32,460／26,521〕 | 64,776 | 52,893 |
| Trading liabilities | 交易负债 | 216,019 | 192,883 |
| Accounts payable and other liabilities (included <span class="tex2jax_ignore">&#36;6,660</span> and <span class="tex2jax_ignore">&#36;5,893</span> at fair value) | 应付账款及其他负债〔其中按公允价值计量6,660／5,893〕 | 316,794 | 280,672 |
| Beneficial interests issued by consolidated VIEs (included <span class="tex2jax_ignore">&#36;5</span> and <span class="tex2jax_ignore">&#36;1</span> at fair value) | 合并VIE发行的受益权益〔其中按公允价值计量5／1〕 | 27,951 | 27,323 |
| Long-term debt (included <span class="tex2jax_ignore">&#36;134,559</span> and <span class="tex2jax_ignore">&#36;100,780</span> at fair value) | 长期债务〔其中按公允价值计量134,559／100,780〕 | 435,206 | 401,418 |
...
| Preferred stock (<span class="tex2jax_ignore">&#36;1</span> par value; authorized 200,000,000 shares: issued 2,005,375 and 2,005,375 shares) | 优先股：面值每股1美元；授权200,000,000股；两期已发行均为2,005,375股 | 20,045 | 20,050 |
| Common stock (<span class="tex2jax_ignore">&#36;1</span> par value; authorized 9,000,000,000 shares; issued 4,104,933,895 shares) | 普通股：面值每股1美元；授权9,000,000,000股；已发行4,104,933,895股 | 4,105 | 4,105 |
...
单位：USD M，股份和面值按行标注；括号为减项，空白表示无金额披露. 脚注(a)列示的 VIE 资产负债已包含在主表，并扣除了合并抵销的集团内余额.
...
单位：USD M，按原PDF第201页重排. 现金集合为 cash and due from banks and deposits with banks；经营性金融资产与客户存款筹资分别进入对应活动类别.

</details>

### 收入、信用成本与费用

利息收入193,341−利息支出97,898＝净利息收入95,443；加非利息收入87,004＝净收入182,447. 扣信用损失计提14,212、非利息费用95,640＝税前72,595，再扣税15,547＝净利润57,048. 资金业务的利息成本直接参与净利息收入计算. [^jpmincome]

FY2025净收入同比增加4,891，信用损失计提增加3,534、非利息费用增加3,843，税前利润减少2,486. 税费减少1,063后，净利润减少1,423. 贷款组合、准备估计和费用组成提供进一步解释入口.

### 资产、融资与现金分类

贷款1,493,429−贷款损失准备25,765＝净贷款1,467,664. 25,765为期末资产减项，信用损失计提14,212为期间费用. 客户存款2,559,320为资金来源负债，交易资产、证券和借入证券用于相应经营活动. [^jpmbs]

经营现金流−147,782包含交易资产变动−156,461、借入证券−66,648、待售贷款发放及购买−260,772，以及出售、证券化和偿还所得235,232；存款现金变动列入筹资活动. 现金余额由469,317−147,782−265,565＋269,533＋17,835＝343,338闭合. [^jpmcash]

集团季度平均 HQLA 961,979、净流出868,500，披露 LCR 111%；银行法人同期 LCR 为115%. 期末未扣监管 haircut 的 HQLA 约915 B美元，其他无抵押证券548 B美元，两项约1,463 B美元，年报概述约1,500 B美元. 抵押融资能力449 B美元另列，已排除由前述资产产生的相关借款能力，提款仍受融资条件约束. [^jpmliq]
...
期末存款增加2,559,320−2,406,032＝153,288，其中 CIB 增加119,826，CCB 16,140，AWM 9,029，公司层8,293. MD&A 将 CIB 变化联系到支付和证券服务中的客户资金活动. [^jpmdeposits]

可检验的解释包括客户交易和服务活动扩大、利率或账户产品变化引起的资金迁移. 分业务平均余额、存款成本、客户流量及账户类型有助于区分这些机制及其持续性.

<a id="bf22-bank-onepage"></a>
### 普通股归属与银行分析记录

集团权益362,438−优先股20,045＝普通股账面权益342,393. 期末已发行4,104,933,895股−库存股1,408,661,319股＝在外2,696,272,576股；年度稀释加权股数2,781.5 M股. 集团净利润57,048与普通股可归属利润55,681相差1,367，差额的具体归属需继续查附注. [^jpmbs]
...
若将存款增长解释为稳定的经营性客户资金，应检查账户类型、客户流量及平均余额. 若增量集中于短暂的期末机构存款，平均余额未同步增长，该解释就会减弱.

</details>

<details data-agent-option="svb"><summary>历史迁移：SVB 2023</summary>
<a id="bf22-svb"></a>

美联储 SVB 复盘记录未保险存款集中、内部流动性压力测试及应急融资缺陷. 2023-03-09实际提款超过40 B美元，管理层预计次日再提款100 B美元. [^svb]

<strong>任务：</strong>用“资产—负债—可操作融资—时间”四格，解释为什么仅有低信用风险证券不够；并辨认其中哪个提款量是当时预期.

<strong>解析.</strong> 证券提供回收和抵押资源，出售价格、结算时间及抵押准备决定可用时间；集中且未保险的存款使提款可能同时发生. 需检查融资渠道是否测试、抵押物是否到位、提款能否完成. 3月9日40 B美元以上为实际流出，次日100 B美元为当时预期.
...
按六个字段填写所选公司的分析，附原表定位、期间、单位和待核证据.

<div data-experiment-slot="EXP-BF22-ONE-PAGE-BUILDER"></div>

<details data-agent-option="research"><summary>选读：多渠道披露评价</summary>
<a id="bf22-research"></a>

Dechow等（2026）将报表、non-GAAP指标与管理层沟通纳入多渠道评价. §8以2024Q2的18家公司试用框架：在 S&P 500、MidCap 400、SmallCap 600 中，分别按三个行业各选两家同行. 部分难编码指标未进入计算，评价范围因可取得和可编码的信息而受限. [^disclosure]

</details>

[^map]: SEC，[Beginners’ Guide to Financial Statements](https://www.sec.gov/about/reports-publications/beginners-guide-financial-statements)，四表、附注、MD&A及Bringing It All Together单元.
...
[^costincome]: 同份[Costco 10-K](https://www.sec.gov/Archives/edgar/data/909832/000090983225000101/cost-20250831.htm)，Consolidated Statements of Income及MD&A Gross Margin.
[^costcash]: 同份[Costco 10-K](https://www.sec.gov/Archives/edgar/data/909832/000090983225000101/cost-20250831.htm)，Consolidated Statements of Cash Flows及两期资产负债表库存/应付行.
...
[^wmtpolicy]: [Walmart FY2026 Form 10-K](https://www.sec.gov/Archives/edgar/data/104169/000010416926000055/wmt-20260131.htm)，Item 1分部及期间、Note 1 Inventories；2026-01-31年度.
...
Costco FY2025、52周，合并集团. 商品销售与会员服务共享门店、物业和租赁资源. 经营利润(269912−239886)+5323−24966=10383；净利润10383−154+589−2719=8099. 现金9906+13335−5311−3775+6=14161. 权益29164；期末443237000股，与EPS加权分母不同. 库存/应付反向变化893，CFO对应963，未分解差70. 下一观察是匹配期次销量/库存构成及采购/付款条款.

### 银行

JPM FY2025集团. NII95443+非息87004−准备14212−非息费用95640=税前72595；净利润57048. 贷款净额1493429−25765=1467664；存款2559320. 现金469317−147782−265565+269533+17835=343338. 权益362438−优先20045=普通股342393；期末在外2696272576股. 集团季度平均 LCR 为111%. 存款增153288，CIB增119826；区分客户活动与产品定价/配置变化，下一步读平均余额、成本、资金流和集中度.

### 迁移解析

Walmart FY2026：美国资本16468+5571+1406=23445，加国际3197=26642；CFO41565−26642=FCF14923，按公司定义，债务服务及收购等支出另列. 三分部、期间和库存方法须重新定位. SVB：2023-03-09超过40 B 美元为已实现流出，次日100 B 美元为管理层预期；资产变现时间及抵押操作决定付款日的可用资金.
...
- [Beyond earnings quality: evaluating the quality of corporate disclosure practices](https://link.springer.com/article/10.1007/s11142-026-09971-2): 联读调整项目的持续性、分母及其他披露的框架. 材料中的 18 家公司试用覆盖 2024Q2.
...
[
  ...
  },
  {
    ...
    "relation": "supported_by",
    "to": "BFFG-R02",
    "reason": "透明度、持续性、分母与其他披露的联合评价；2024Q2的18家公司试用.",
    "locator": [
      "Introduction",
      "§3.2–3.3",
      "§8 pilot及实施边界"
