...
```json
{
  "required_readings": [
    {
      "source_id": "nb-a02-source-bond-terms",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.investor.gov/introduction-investing/general-resources/news-alerts/alerts-bulletins/investor-bulletins/what-are"
      },
      "required_unit": {
        "locator": "What are the financial terms of a bond?；Credit/default Risk；Call Risk",
        "scope": "What are the financial terms of a bond?；Credit/default Risk；Call Risk",
        "purpose": "债券面值、票息、还本时点及履约和提前赎回条件；本文数值为独立教学设定。"
      },
      "title": "SEC：What Are Corporate Bonds?",
      "authors": [
    ...
    },
    {
      ...
      "required_unit": {
        "locator": "Options by Underlying Asset；Options by Expiration；Expiration Risk",
        "scope": "Options by Underlying Asset；Options by Expiration；Expiration Risk",
        "purpose": "股票期权的权利、到期、交付与购股资金；不将股票交割方式推广到所有期权。"
      },
      "title": "FINRA—Options",
      "authors": [
        "FINRA"
  ...
  "required_readings_by_branch": {
    "过桥与出售比较": [
      {
        ...
        "required_unit": {
          "locator": "Selling Before the Maturity Date；Bond Pricing",
          "scope": "Selling Before the Maturity Date；Bond Pricing",
          "purpose": "提前出售的资金回收与市场价格；不把给定净卖价当作实际证券报价。"
        },
        "title": "FINRA—Bonds",
        "authors": [
          "FINRA"
      ...
      {
        "source_id": "nb-a02-source-credit",
        "access": {
          "kind": "selected_chapters",
          "uri": "https://www.finra.org/investors/insights/securities-backed-lines-credit"
        },
        "required_unit": {
          "locator": "What Are SBLOCs?；Interest Rates and Repayment；问题4、8",
          "scope": "What Are SBLOCs?；Interest Rates and Repayment；问题4、8",
          "purpose": "保留资产取得现金仍有融资成本和合同要求。SBLOC不得用于购买或交易证券；本文借款为独立教学设定。"
        },
        "title": "FINRA：Securities-Backed Lines of Credit Explained",
        "authors": [
          "FINRA"
        ],
        "version": "本篇实际阅读日期：2026-09-24"
    ...
    "期权的有效期": [
      {
        "source_id": "nb-a02-source-long-call",
        "access": {
          "kind": "selected_chapters",
          "uri": "https://www.optionseducation.org/strategies/all-strategies/long-call"
        },
        "required_unit": {
          "locator": "Description；Max Loss；Profit/Loss；Expiration Risk",
          "scope": "Description；Max Loss；Profit/Loss；Expiration Risk",
          "purpose": "买入看涨期权的权利金、有限有效期、到期失效与行权购股资金。"
        },
        "title": "OIC：Long Call",
        "authors": [
          "Options Industry Council / OCC"
        ],
        "version": "本篇实际阅读日期：2026-09-24"
      }
    ],
    "现金何时可用": [
      {
        ...
        "required_unit": {
          "locator": "What is Settlement?",
          "scope": "What is Settlement?",
          "purpose": "成交与证券、款项正式交付的区别；本文不推广美国特定周期。"
        },
...
- [SEC：What Are Corporate Bonds?](https://www.investor.gov/introduction-investing/general-resources/news-alerts/alerts-bulletins/investor-bulletins/what-are): 债券面值、票息、还本时点及履约和提前赎回条件；本文数值为独立教学设定。
- [FINRA：Securities-Backed Lines of Credit Explained](https://www.finra.org/investors/insights/securities-backed-lines-credit): 保留资产取得现金仍有融资成本和合同要求。SBLOC不得用于购买或交易证券；本文借款为独立教学设定。
- [OIC：Long Call](https://www.optionseducation.org/strategies/all-strategies/long-call): 买入看涨期权的权利金、有限有效期、到期失效与行权购股资金。
...
[
  {
    "from": "zh-investment-horizon-cash",
    "relation": "part_of",
    "to": "topic-A",
    "reason": "主要 topic 归属"
  }
