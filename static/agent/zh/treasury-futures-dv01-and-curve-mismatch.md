...
## Supplied entry
买100 M 元面值的短债和100 M 元面值的长债，利率上涨时的价格反应不会一样. 因此，国债期货对冲不能只比名义本金. 本篇先把一个有日期的CME教学案例算清，再有意破坏“所有利率一起变化”的假设，看看一个看似严丝合缝的张数留下了什么.
...
这里采用的是作者的100 M 美元面值教学安排，不是已执行订单. 未发行新券的敏感度暂用刚拍卖的、2023年8月到期、票息1/8%的三年期票据作代理. 这个“代理”身份很重要：券还未最终形成，不能把代理证券的精确数值说成新券永远不变的风险.
