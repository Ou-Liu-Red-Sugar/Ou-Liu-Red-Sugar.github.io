...
Entry: zh-bf18 | Node: BF-18 | Language: zh | Editorial revision: 2026-09-21

## Teaching instructions
你正在教 BF-18《分部、合并范围与共同资源》，材料版本2026-09-21。学习任务：CAT路径重建67,589收入和11,541税前；软件路径完成不冒造产品利润的资源地图。
先确认读者所选主分支（默认industrial）；required_readings只读common及该分支。all才读取全部主分支。 optional只有读者启用后才变为必读。先实际打开指定公开原文单元，分页读到单元结束，必要表图核原页，记录标题/版本/位置/范围与当前用途。文献目录、工具返回标题或作者先前已读记录都不能代替本次读取；runtime_reading_log从空数组开始。读取失败先找同版本正式等价原文，仍缺则说明该单元缺口，不凭摘要补讲。
诊断任务：{"industrial": "核CAT收入67,589、报告分部到税前11,541和完整调整项。", "software": "用Agentforce Sales FY2026收入9,028走完“具名产品收入→共同平台/集团R&D→一个operating segment→合并净利润”路径，并标出未披露产品利润。"}。补充任务：先请读者给分部利润核对表命名终点，再判断11,151还是11,541。
随后沿本包完整正文、实际输入、静态实验与题解推进一个完整任务，先让读者解释或计算再反馈；已会的基础跳过。默认先用所选公司同一原件的比较期完成迁移；跨公司对照只有读者启用后才补读另一公司完整单元。通过尺度：保留FP external列712脚注，内部列归零；软件分支必须定位Note2 p70的Agentforce Sales 9,028，并保持产品收入不等同报告分部利润。
...
{
  "export_mode": "public",
  "default_branch": "industrial",
  "branch_options": [
    "industrial",
    "software"
  ],
  "branch_tasks": {
    "industrial": "核CAT收入67,589、报告分部到税前11,541和完整调整项。",
    "software": "用Agentforce Sales FY2026收入9,028走完“具名产品收入→共同平台/集团R&D→一个operating segment→合并净利润”路径，并标出未披露产品利润。"
  },
  "selection_rules": {
    "common": "始终必读",
    "selected": "只读所选主分支",
  ...
  "required_readings": [
    {
      ...
      "required_unit": {
        "locator": "Note23 pp115–118,120–121",
        "scope": "A/B/C业务与计量、完整收入/利润表/脚注/税前核对；Statement1 operating-to-pretax",
        "purpose": "CAT分部合并及同份报告2024迁移"
      },
  ...
  "default_outputs": {
    "segments": {
      ...
      "revenue": {
        ...
        "rows": [
          {
            "label": "All Other Segment",
            "value": 327,
            "before": 73955,
            "after": 74282
          },
          {
            "label": "Corporate Items and Eliminations",
            "value": -6693,
            "before": 74282,
            "after": 67589
          }
      ...
      "profit": {
        ...
        "rows": [
          {
            "label": "Profit from All Other Segment／其他分部利润",
            "value": -8,
            "before": 14047,
            "after": 14039
          },
          {
            "label": "Cost centers／成本中心",
            "value": -11,
            "before": 14039,
            "after": 14028
          },
          {
            "label": "Corporate costs／公司共同成本",
            "value": -1006,
            "before": 14028,
            "after": 13022
          },
          ...
          {
            "label": "Restructuring costs／重组成本",
            "value": -445,
            "before": 12847,
            "after": 12402
          },
          {
            "label": "Inventory/cost of sales／存货／销售成本计量",
            "value": 49,
            "before": 12402,
            "after": 12451
          },
          {
            "label": "Postretirement benefit income (expense)／退休后福利收益（费用）",
            "value": 185,
            "before": 12451,
            "after": 12636
          },
          {
            "label": "Stock-based compensation expense／股权薪酬费用",
            "value": -230,
            "before": 12636,
            "after": 12406
          },
          {
            "label": "Financing costs／融资成本",
            "value": -180,
            "before": 12406,
            "after": 12226
          },
          ...
          {
            "label": "Goodwill impairment charge／商誉减值",
            "value": 0,
            "before": 12145,
            "after": 12145
          },
          {
            "label": "Other income/expense methodology differences／其他损益计量方法差异",
            "value": -470,
            "before": 12145,
            "after": 11675
          },
          {
            "label": "Other methodology differences／其他方法差异",
            "value": -134,
            "before": 11675,
            "after": 11541
          }
      ...
      "external": 67589,
      "intersegment": 0,
      "fp_external_includes_group": 712,
      "operating_to_pretax": {
        "opening": 11151,
        "rows": [
          {
            "label": "Interest expense excluding Financial Products",
            "value": -502,
            "before": 11151,
            "after": 10649
          },
  ...
  "prompt": "你正在教 BF-18《分部、合并范围与共同资源》，材料版本2026-09-21。学习任务：CAT路径重建67,589收入和11,541税前；软件路径完成不冒造产品利润的资源地图。\n先确认读者所选主分支（默认industrial）；required_readings只读common及该分支。all才读取全部主分支。 optional只有读者启用后才变为必读。先实际打开指定公开原文单元，分页读到单元结束，必要表图核原页，记录标题/版本/位置/范围与当前用途。文献目录、工具返回标题或作者先前已读记录都不能代替本次读取；runtime_reading_log从空数组开始。读取失败先找同版本正式等价原文，仍缺则说明该单元缺口，不凭摘要补讲。\n诊断任务：{\"industrial\": \"核CAT收入67,589、报告分部到税前11,541和完整调整项。\", \"software\": \"用Agentforce Sales FY2026收入9,028走完“具名产品收入→共同平台/集团R&D→一个operating segment→合并净利润”路径，并标出未披露产品利润。\"}。补充任务：先请读者给分部利润核对表命名终点，再判断11,151还是11,541。\n随后沿本包完整正文、实际输入、静态实验与题解推进一个完整任务，先让读者解释或计算再反馈；已会的基础跳过。默认先用所选公司同一原件的比较期完成迁移；跨公司对照只有读者启用后才补读另一公司完整单元。通过尺度：保留FP external列712脚注，内部列归零；软件分支必须定位Note2 p70的Agentforce Sales 9,028，并保持产品收入不等同报告分部利润。\n保持真实披露、分析计算、教学模型三种身份，参数只改变模型，不反写真实公司数据。资料不足处不要补造差额或估值。最后明确：读者已经能独立重建什么，换一份材料时还需先核哪些条件？",
  "selected_branch": "industrial",
    ...
    "software": [
      {
        ...
        "required_unit": {
          "locator": "Note1 consolidation/Segments p63; Note2 p70 service-offering revenue table and footnotes; Statement p58 and R&D notes",
          "scope": "完整单分部政策、Agentforce Sales具名收入表/脚注与集团研发口径",
          "purpose": "用具名产品完成单分部业务—共同资源—集团终点分析"
        },
  ...
  "experiment_ids": [
    "EXP-BF18-SEGMENT-RECONCILIATION"
  ]
}
```
...
以下保留 Note 23 收入表的外部、内部与合计列，省略的是地理分布细列，而不是合并所需的主板块。单位百万美元，期间为 2025 年全年。
...
这张表不是公司自己报告的分部表，而是围绕真实披露建立的分析地图。它让我们问得更细，却不额外制造财务结果。比如，FY2026 研发 5,993 中已经含 1,162 股权薪酬；当研究者讨论多个产品使用同一个平台时，这是一笔已经记录的集团费用，不能给每个产品再加一遍完整集团研发。[^bf18-crm-fs]
...
完成所选分支后，写下对象边界、来源期次、采用的利润定义与合并终点，再选一个共同资源说明为什么它跨业务。工业路线应交出 67,589 的收入桥和 11,541 的税前桥；软件路线应交出一张不重复集团费用、也不冒造产品利润的资源地图。换公司时，先重复这个动作，再计算你关心的利润率。这样“拆业务”才不是按股票标签给数字分组，而是在明确的记录范围内解释经营。
...
[^bf18-cat-recon]: 同一原件 Note 23，Reconciliation of Consolidated profit before taxes，p121，全部调整项；经营到税前取 Statement 1 对应层次。均为百万美元。
...
[^bf18-crm-product]: 同一 Salesforce FY2026 原件，Note 2 `Subscription and Support Revenue by the Company's Service Offerings`，p70：Agentforce Sales FY2026/2025/2024 分别为 9,028/8,322/7,580；表下注明 FY2026 第三季度产品命名变化未改变收入分配。金额百万美元。
...
[
  {
    "id": "EXP-BF18-SEGMENT-RECONCILIATION",
    "title": "分部、合并范围与共同资源：同源实验",
    "anchor": "bf18-experiment",
    "description": "CAT报告分部总额加All Other及完整调整项，收入回67,589，分部利润回税前11,541。经营利润11,151经-502+892另回税前。软件视图保留多产品/单分部。",
    "inputs": {
      "input_id": "BFDE-SHARED-20260921-v1",
    ...
    "algorithm": "CAT报告分部总额加All Other及完整调整项，收入回67,589，分部利润回税前11,541。经营利润11,151经-502+892另回税前。软件视图保留多产品/单分部。",
    "boundaries": "保留FP external列712脚注，内部列归零；软件多产品不等同报告多分部。",
    "local_url": "/notebook/labs/bf-de/interactions.html#EXP-BF18-SEGMENT-RECONCILIATION",
    "static_equivalent": {
      "html": "https://ou-liu-red-sugar.github.io/notebook/labs/bf-de/static.html#EXP-BF18-SEGMENT-RECONCILIATION",
...
[
  ...
  },
  {
    ...
    "to": "CASE-BFDE-CAT-BF18-20260921",
    "reason": "固定期间的教学案例，不指向动态最新研究"
  },
  {
    "from": "zh-bf18",
    "relation": "illustrated_by",
    "to": "CASE-BFDE-CRM-BF18-20260921",
    "reason": "固定期间的教学案例，不指向动态最新研究"
  },
  {
    "from": "zh-bf18",
  ...
  {
    "from": "bf18-experiment",
    "relation": "illustrated_by",
    "to": "EXP-BF18-SEGMENT-RECONCILIATION",
    "reason": "CAT报告分部总额加All Other及完整调整项，收入回67,589，分部利润回税前11,541。经营利润11,151经-502+892另回税前。软件视图保留多产品/单分部。",
    "at_section": "bf18-experiment",
    "conditions": "保留FP external列712脚注，内部列归零；软件多产品不等同报告多分部。"
  }
]
```
...
拆一份企业财报: step 8/14
选工业或软件分支，核分部与共同资源的实际边界。
口径和终点明确之后，解释量价成本怎样形成利润变化。
Next: [单位经济、成本结构与经营杠杆](https://ou-liu-red-sugar.github.io/zh/notebook/unit-economics-cost-structure-and-operating-leverage/)
