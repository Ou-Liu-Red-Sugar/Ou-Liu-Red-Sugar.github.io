...
从企业与资金的复利累积出发，用指数、对数、购买力和现实替代理解持有回报，并引入 Sharpe 比较。

Entry: zh-compounding-inflation-opportunity-cost | Node: NB-A04 | Language: zh | Editorial revision: 2026-09-26

## Teaching instructions
按三个主节讲解：复利世界与回报累积、净所得与实际购买力、机会成本与风险补偿。先用Buffett与KO长期股东所得说明经营会随时间发展，再连续讲增长因子、连续复利exp、贴现作为相同计息过程的逆向换算、对数收益、短期一阶近似与年化；不要将企业案例插入exp和ln之间。VOO 2015年底至2025年底采用含分红调整的Yahoo AdjClose，作为税前分红再投资总回报的近似；不是逐笔按券商实际成交价重建的账户。仅价格变化终值约33548.92，分红留不计息现金总额36524.96，按除息日收盘价再投39721.41；图中原调整价口径终值39746.89，分红已经计入，不能另加一次。原分配再投资回报按Yahoo调整后收盘价计算，初始10000美元至约39746.89，年化约14.797%；同期间美国CPI-U未季调236.525至324.054，期末基期购买力约29011.01。2025年10月CPI缺报，数据保持空值，图以虚线连接相邻已知月份，不把缺失点写成实测值。复利互动固定连续复利率5%；费用示例采用毛年回报8%、每年末扣费0.25%或1%、20年。短债CUSIP912797FS1的2023-06-13拍卖价格95.015222/100，2023-06-15至2024-06-13，预算10000美元可持10500面值及23.40现金，到期10523.40；同期间VOO事后结果约12443.65。Sharpe采用1994原文假设基金X/Y，预期5%/8%、标准差10%/20%、同期无风险3%，比率0.20/0.25；不要称为实际基金历史排名或擅加自然年。标准Sharpe使用同频普通超额收益；指数、对数用于跨期累积。美联储长期2%目标对应总体PCE，政策细节链接《美联储与货币政策》。正文简明，精细口径用已有详细版。
...
```json
{
  "required_readings": [
    {
      "source_id": "nb-a04-buffett-1989-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.berkshirehathaway.com/letters/1989.html"
      },
      "required_unit": {
        "locator": "Warren Buffett，Berkshire Hathaway 1989 年股东信，Mistakes of the First Twenty-five Years：优秀企业、合理价格与时间的关系。",
        "scope": "Warren Buffett，Berkshire Hathaway 1989 年股东信，Mistakes of the First Twenty-five Years：优秀企业、合理价格与时间的关系。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
      "title": "Berkshire Hathaway 1989 年股东信",
      "authors": [
        "Berkshire Hathaway 1989 年股东信"
      ],
      "version": "本篇核对日期：2026-09-26；历史期间见正文脚注"
    },
    {
      "source_id": "nb-a04-buffett-2022-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.berkshirehathaway.com/letters/2022ltr.pdf"
      },
      "required_unit": {
        "locator": "Warren Buffett，2022 年股东信，The Secret Sauce：KO 长期持股与年度现金股息。文中金额为 Berkshire 收到的年度分红，分别对应 1994 年与 2022 年。",
        "scope": "Warren Buffett，2022 年股东信，The Secret Sauce：KO 长期持股与年度现金股息。文中金额为 Berkshire 收到的年度分红，分别对应 1994 年与 2022 年。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
      "title": "2022 年股东信",
      "authors": [
    ...
    {
      "source_id": "nb-a04-compound-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://math.nyu.edu/~goodman/teaching/MathFin2019/handouts/CompoundInterest.pdf"
      },
      "required_unit": {
        "locator": "Jonathan Goodman，NYU Courant，Compound interest：离散与连续复利、指数及对数的一阶近似。",
        "scope": "Jonathan Goodman，NYU Courant，Compound interest：离散与连续复利、指数及对数的一阶近似。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
    ...
    {
      "source_id": "nb-a04-voo-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://fund-docs.vanguard.com/F0968.pdf"
      },
      "required_unit": {
        "locator": "Vanguard，VOO 官方资料，基金跟踪对象及分配再投资、税前与扣除基金费用后的业绩口径。本文历史曲线采用下一条列明的市场数据。",
        "scope": "Vanguard，VOO 官方资料，基金跟踪对象及分配再投资、税前与扣除基金费用后的业绩口径。本文历史曲线采用下一条列明的市场数据。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
      "title": "VOO 官方资料",
      "authors": [
    ...
    {
      "source_id": "nb-a04-voo-data-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://finance.yahoo.com/quote/VOO/history/"
      },
      "required_unit": {
        "locator": "Yahoo Finance：VOO 历史行情，读取于 2026-09-26。2015-12-31 至 2025-12-31，调整后收盘价由 156.8276978 至 623.3413696，累计增长约 297.47%；2023-06-15 至 2024-06-13 的对应值为 389.5532837、484.7463074，增长约 24.44%。每日输入与月末资金路径及购买力计算供复算。",
        "scope": "Yahoo Finance：VOO 历史行情，读取于 2026-09-26。2015-12-31 至 2025-12-31，调整后收盘价由 156.8276978 至 623.3413696，累计增长约 297.47%；2023-06-15 至 2024-06-13 的对应值为 389.5532837、484.7463074，增长约 24.44%。每日输入与月末资金路径及购买力计算供复算。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
      "title": "Yahoo Finance：VOO 历史行情",
      "authors": [
        "Yahoo Finance"
      ],
      "version": "本篇核对日期：2026-09-26；历史期间见正文脚注"
    ...
    {
      "source_id": "nb-a04-voo-adjustment-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://help.yahoo.com/kb/SLN28256.html"
      },
      "required_unit": {
        "locator": "Yahoo：What is the adjusted close?，调整后收盘价包含分红与拆股调整。本文原始数据中有40次分红事件，以除息日前一交易日价格计算分红调整因子；这与逐笔按实际成交价再投资的规则不同。起止普通收盘价为186.9299927、627.1300049美元，仅价格变化对应的期末金额为33,548.92美元；分红事件与复算输入列出两种再投资口径及现金分红。",
        "scope": "Yahoo：What is the adjusted close?，调整后收盘价包含分红与拆股调整。本文原始数据中有40次分红事件，以除息日前一交易日价格计算分红调整因子；这与逐笔按实际成交价再投资的规则不同。起止普通收盘价为186.9299927、627.1300049美元，仅价格变化对应的期末金额为33,548.92美元；分红事件与复算输入列出两种再投资口径及现金分红。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
      "title": "Yahoo：What is the adjusted close?",
      "authors": [
        "Yahoo"
      ],
      "version": "本篇核对日期：2026-09-26；历史期间见正文脚注"
    ...
    {
      "source_id": "nb-a04-fees-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.investor.gov/introduction-investing/general-resources/news-alerts/alerts-bulletins/investor-bulletins/updated"
      },
      "required_unit": {
        "locator": "SEC Investor.gov，How Fees and Expenses Affect Your Investment Portfolio，持续费用与后续投资本金。本文金额按所列假设自行计算。",
        "scope": "SEC Investor.gov，How Fees and Expenses Affect Your Investment Portfolio，持续费用与后续投资本金。本文金额按所列假设自行计算。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
    ...
    {
      "source_id": "nb-a04-cpi-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.bls.gov/cpi/factsheets/purchasing-power-constant-dollars.htm"
      },
      "required_unit": {
        "locator": "BLS，Purchasing power and constant dollars及CUUR0000SA0 数据，美国城市消费者、全项目、未季调 CPI。2015年12月为236.525，2025年12月为324.054。截至2026-09-26复核，本图所用未季调全项目CPI-U的2025年10月官方值仍缺失。BLS为季调计算采用了9月与11月指数的几何平均估补，并补发部分非调查分项；这与发布本系列10月正式值有别，见缺失数据与后续处理说明第2、3、12项。图中虚线连接相邻已知月份，数据表中该月仍留空；计算输入。",
        "scope": "BLS，Purchasing power and constant dollars及CUUR0000SA0 数据，美国城市消费者、全项目、未季调 CPI。2015年12月为236.525，2025年12月为324.054。截至2026-09-26复核，本图所用未季调全项目CPI-U的2025年10月官方值仍缺失。BLS为季调计算采用了9月与11月指数的几何平均估补，并补发部分非调查分项；这与发布本系列10月正式值有别，见缺失数据与后续处理说明第2、3、12项。图中虚线连接相邻已知月份，数据表中该月仍留空；计算输入。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
    ...
    {
      "source_id": "nb-a04-cpi-2",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://data.bls.gov/timeseries/CUUR0000SA0"
      },
      "required_unit": {
        "locator": "BLS，Purchasing power and constant dollars及CUUR0000SA0 数据，美国城市消费者、全项目、未季调 CPI。2015年12月为236.525，2025年12月为324.054。截至2026-09-26复核，本图所用未季调全项目CPI-U的2025年10月官方值仍缺失。BLS为季调计算采用了9月与11月指数的几何平均估补，并补发部分非调查分项；这与发布本系列10月正式值有别，见缺失数据与后续处理说明第2、3、12项。图中虚线连接相邻已知月份，数据表中该月仍留空；计算输入。",
        "scope": "BLS，Purchasing power and constant dollars及CUUR0000SA0 数据，美国城市消费者、全项目、未季调 CPI。2015年12月为236.525，2025年12月为324.054。截至2026-09-26复核，本图所用未季调全项目CPI-U的2025年10月官方值仍缺失。BLS为季调计算采用了9月与11月指数的几何平均估补，并补发部分非调查分项；这与发布本系列10月正式值有别，见缺失数据与后续处理说明第2、3、12项。图中虚线连接相邻已知月份，数据表中该月仍留空；计算输入。",
    ...
    {
      "source_id": "nb-a04-cpi-3",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.bls.gov/cpi/additional-resources/2025-federal-government-shutdown-impact-cpi-faq.htm"
      },
      "required_unit": {
        "locator": "BLS，Purchasing power and constant dollars及CUUR0000SA0 数据，美国城市消费者、全项目、未季调 CPI。2015年12月为236.525，2025年12月为324.054。截至2026-09-26复核，本图所用未季调全项目CPI-U的2025年10月官方值仍缺失。BLS为季调计算采用了9月与11月指数的几何平均估补，并补发部分非调查分项；这与发布本系列10月正式值有别，见缺失数据与后续处理说明第2、3、12项。图中虚线连接相邻已知月份，数据表中该月仍留空；计算输入。",
        "scope": "BLS，Purchasing power and constant dollars及CUUR0000SA0 数据，美国城市消费者、全项目、未季调 CPI。2015年12月为236.525，2025年12月为324.054。截至2026-09-26复核，本图所用未季调全项目CPI-U的2025年10月官方值仍缺失。BLS为季调计算采用了9月与11月指数的几何平均估补，并补发部分非调查分项；这与发布本系列10月正式值有别，见缺失数据与后续处理说明第2、3、12项。图中虚线连接相邻已知月份，数据表中该月仍留空；计算输入。",
    ...
    {
      "source_id": "nb-a04-fed-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.federalreserve.gov/monetarypolicy/files/fomc_longerrungoals.pdf"
      },
      "required_unit": {
        "locator": "Federal Reserve，Statement on Longer-Run Goals and Monetary Policy Strategy，2026-01-27 再确认；长期 2% 通胀目标说明。",
        "scope": "Federal Reserve，Statement on Longer-Run Goals and Monetary Policy Strategy，2026-01-27 再确认；长期 2% 通胀目标说明。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
    ...
    {
      "source_id": "nb-a04-fed-2",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.federalreserve.gov/faqs/economy_14400.htm"
      },
      "required_unit": {
        "locator": "Federal Reserve，Statement on Longer-Run Goals and Monetary Policy Strategy，2026-01-27 再确认；长期 2% 通胀目标说明。",
        "scope": "Federal Reserve，Statement on Longer-Run Goals and Monetary Policy Strategy，2026-01-27 再确认；长期 2% 通胀目标说明。",
    ...
    {
      "source_id": "nb-a04-bill-1",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.treasurydirect.gov/instit/annceresult/press/preanre/2023/R_20230613_2.pdf"
      },
      "required_unit": {
        "locator": "TreasuryDirect，2023-06-13 拍卖结果及发行公告：364 天国债，CUSIP 912797FS1，每100美元面值价格95.015222，2023-06-15发行，2024-06-13到期。10,500美元面值的成本取到分为9,976.60美元。",
        "scope": "TreasuryDirect，2023-06-13 拍卖结果及发行公告：364 天国债，CUSIP 912797FS1，每100美元面值价格95.015222，2023-06-15发行，2024-06-13到期。10,500美元面值的成本取到分为9,976.60美元。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
      "title": "2023-06-13 拍卖结果",
      "authors": [
        "2023-06-13 拍卖结果"
      ],
      "version": "本篇核对日期：2026-09-26；历史期间见正文脚注"
    ...
    {
      "source_id": "nb-a04-bill-2",
      "access": {
        "kind": "selected_chapters",
        "uri": "https://www.treasurydirect.gov/instit/annceresult/press/preanre/2023/A_20230608_2.pdf"
      },
      "required_unit": {
        "locator": "TreasuryDirect，2023-06-13 拍卖结果及发行公告：364 天国债，CUSIP 912797FS1，每100美元面值价格95.015222，2023-06-15发行，2024-06-13到期。10,500美元面值的成本取到分为9,976.60美元。",
        "scope": "TreasuryDirect，2023-06-13 拍卖结果及发行公告：364 天国债，CUSIP 912797FS1，每100美元面值价格95.015222，2023-06-15发行，2024-06-13到期。10,500美元面值的成本取到分为9,976.60美元。",
    ...
    },
    {
      ...
      "required_unit": {
        "locator": "William F. Sharpe，The Sharpe Ratio，The Ratio、Time Dependence、Related Measures。X/Y与半仓Y的比较均来自原文假设，所有收益和标准差采用同一期口径。",
        "scope": "William F. Sharpe，The Sharpe Ratio，The Ratio、Time Dependence、Related Measures。X/Y与半仓Y的比较均来自原文假设，所有收益和标准差采用同一期口径。",
        "purpose": "核对本篇实际采用的定义、实例、行情与购买力输入。"
      },
...
## Sources
- [2023-06-13 拍卖结果](https://www.treasurydirect.gov/instit/annceresult/press/preanre/2023/R_20230613_2.pdf): TreasuryDirect，2023-06-13 拍卖结果及发行公告：364 天国债，CUSIP 912797FS1，每100美元面值价格95.015222，2023-06-15发行，2024-06-13到期。10,500美元面值的成本取到分为9,976.60美元。
- [发行公告](https://www.treasurydirect.gov/instit/annceresult/press/preanre/2023/A_20230608_2.pdf): TreasuryDirect，2023-06-13 拍卖结果及发行公告：364 天国债，CUSIP 912797FS1，每100美元面值价格95.015222，2023-06-15发行，2024-06-13到期。10,500美元面值的成本取到分为9,976.60美元。
- [Berkshire Hathaway 1989 年股东信](https://www.berkshirehathaway.com/letters/1989.html): Warren Buffett，Berkshire Hathaway 1989 年股东信，Mistakes of the First Twenty-five Years：优秀企业、合理价格与时间的关系。
- [2022 年股东信](https://www.berkshirehathaway.com/letters/2022ltr.pdf): Warren Buffett，2022 年股东信，The Secret Sauce：KO 长期持股与年度现金股息。文中金额为 Berkshire 收到的年度分红，分别对应 1994 年与 2022 年。
- [Compound interest](https://math.nyu.edu/~goodman/teaching/MathFin2019/handouts/CompoundInterest.pdf): Jonathan Goodman，NYU Courant，Compound interest：离散与连续复利、指数及对数的一阶近似。
- [Purchasing power and constant dollars](https://www.bls.gov/cpi/factsheets/purchasing-power-constant-dollars.htm): BLS，Purchasing power and constant dollars及CUUR0000SA0 数据，美国城市消费者、全项目、未季调 CPI。2015年12月为236.525，2025年12月为324.054。2025年10月因拨款中断未提供数据，购买力曲线在该月留空；计算输入。
- [CUUR0000SA0 数据](https://data.bls.gov/timeseries/CUUR0000SA0): BLS，Purchasing power and constant dollars及CUUR0000SA0 数据，美国城市消费者、全项目、未季调 CPI。2015年12月为236.525，2025年12月为324.054。2025年10月因拨款中断未提供数据，购买力曲线在该月留空；计算输入。
- [缺失数据与后续处理说明](https://www.bls.gov/cpi/additional-resources/2025-federal-government-shutdown-impact-cpi-faq.htm): BLS，Purchasing power and constant dollars及CUUR0000SA0 数据，美国城市消费者、全项目、未季调 CPI。2015年12月为236.525，2025年12月为324.054。截至2026-09-26复核，本图所用未季调全项目CPI-U的2025年10月官方值仍缺失。BLS为季调计算采用了9月与11月指数的几何平均估补，并补发部分非调查分项；这与发布本系列10月正式值有别，见缺失数据与后续处理说明第2、3、12项。图中虚线连接相邻已知月份，数据表中该月仍留空；计算输入。
- [Statement on Longer-Run Goals and Monetary Policy Strategy](https://www.federalreserve.gov/monetarypolicy/files/fomc_longerrungoals.pdf): Federal Reserve，Statement on Longer-Run Goals and Monetary Policy Strategy，2026-01-27 再确认；长期 2% 通胀目标说明。
- [长期 2% 通胀目标说明](https://www.federalreserve.gov/faqs/economy_14400.htm): Federal Reserve，Statement on Longer-Run Goals and Monetary Policy Strategy，2026-01-27 再确认；长期 2% 通胀目标说明。
- [How Fees and Expenses Affect Your Investment Portfolio](https://www.investor.gov/introduction-investing/general-resources/news-alerts/alerts-bulletins/investor-bulletins/updated): SEC Investor.gov，How Fees and Expenses Affect Your Investment Portfolio，持续费用与后续投资本金。本文金额按所列假设自行计算。
...
- [VOO 官方资料](https://fund-docs.vanguard.com/F0968.pdf): Vanguard，VOO 官方资料，基金跟踪对象及分配再投资、税前与扣除基金费用后的业绩口径。本文历史曲线采用下一条列明的市场数据。
- [Yahoo：What is the adjusted close?](https://help.yahoo.com/kb/SLN28256.html): Yahoo：What is the adjusted close?，调整后收盘价包含分红与拆股调整。本文原始数据中有40次分红事件，以除息日前一交易日价格计算分红调整因子；这与逐笔按实际成交价再投资的规则不同。起止普通收盘价为186.9299927、627.1300049美元，仅价格变化对应的期末金额为33,548.92美元；分红事件与复算输入列出两种再投资口径及现金分红。
- [Yahoo Finance：VOO 历史行情](https://finance.yahoo.com/quote/VOO/history/): Yahoo Finance：VOO 历史行情，读取于 2026-09-26。2015-12-31 至 2025-12-31，调整后收盘价由 156.8276978 至 623.3413696，累计增长约 297.47%；2023-06-15 至 2024-06-13 的对应值为 389.5532837、484.7463074，增长约 24.44%。每日输入与月末资金路径及购买力计算供复算。

## Content relations
```json
[
  {
    "from": "zh-compounding-inflation-opportunity-cost",
    "relation": "part_of",
    "to": "topic-A",
    "reason": "主要 topic 归属"
  }
