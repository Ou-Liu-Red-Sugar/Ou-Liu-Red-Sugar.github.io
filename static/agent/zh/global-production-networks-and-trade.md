...
```json
{
  ...
  "required_readings": [
    {
      ...
      "supports": "美国商品进口的中国来源金额；名义百万美元、未季调。固定2017/2022 TOTAL Imports，不是论文Comtrade产品回归输入。",
      "branch": "common",
      "id": "EI14-all-READ-01"
    },
    {
      ...
      "supports": "同口径美国世界商品进口分母；名义百万美元、未季调。用于本站份额和增长率计算。",
      "branch": "common",
      "id": "EI14-all-READ-02"
    },
    {
  ...
  "supplied_inputs": {
    "trade": {
      ...
      "unit": "nominal USD million; not seasonally adjusted",
      "period": [
        2017,
        2022
      ],
