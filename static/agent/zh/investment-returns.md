...
除了资金用途，选择投资方式时还要考虑资金规模、可投入的时间和能够使用的资源。例如大额资金需要考虑市场能否容纳自己的买卖，频繁交易则需要投入相应的时间和研究资源。常见做法各有侧重：短线交易关注较短时间里的交易机会，量化投资借助数据和规则组织判断与执行，价值投资则重视企业价值与买入价格的关系。这些侧重可以交叉，投资者需要结合自己的条件选择和运用。

这套笔记则以股票的基本面研究为主线。我们从企业的经营出发，研究它靠什么赚钱、未来可能怎样变化，再把这些认识与买入价格放在一起，比较潜在回报和损失。在这项研究中，Agent 可以协助查找资料、追踪上下游和整理新事件；而要把这些材料用于投资判断，我们需要理解业务，辨认依据。本篇就从一项具体业务开始，展示这种研究怎样展开，以及我们需要为此学习什么。
...
一笔订单首先约定双方未来要做什么。有了订单，GEV 还要组织采购、制造和交付，并按合同履约情况确认收入，也就是把相应金额记入财务报表。不过客户实际付款的进度可能与收入确认不同，供应商也有自己的收款安排。因此我们既要比较收入与采购、生产、服务等成本，判断业务能赚多少钱，也要看收付款的时间，判断这段过程需要投入多少资金。[^gev-annual]
...
不过要判断股东可能得到什么，我们还得把这项业务放回整个公司。其他业务的盈亏、公司共同费用、债务和再投资安排，都会影响最终留给股东的结果。结合股份数量，我们才能把公司的经营成果放到每股的尺度上理解，进一步讨论一股股票所代表的未来所得，以及自己愿意为它支付什么价格。

## 事件、预期与市场计价 {#nb-a01-events}

经营前景会随着需求、竞争和供给条件变化，市场也不断围绕订单、财报、技术进展和政策等事件更新预期与价格。基本面研究为判断这些变化提供依据：一条消息有多大分量，要看它改变了哪些经营条件。

再看一条新增设备订单的消息。它是否说明客户的需求正在扩大？GEV 能否利用现有产能完成交付，还是需要追加投资？上游供货、人工与服务成本会不会随之改变？这些问题的答案关系到新增订单能够带来怎样的利润和现金。订单金额本身还没有回答它们，因此研究者需要沿着前面的业务图继续查证。
...
把公司研究用于资产配置时，我们还要考虑股票以外的资金安排：保留可用现金，比较不同资产，并在适当的时候调整已有的风险。因此这套笔记也会介绍其他主要资产，以及基金和合约工具怎样参与投资。
