...
股权薪酬3,509在间接法中加回，只消除该费用对经营现金流的非现金影响；另有351的奖励净额结算税款列在筹资中，权益和股数也会变化. 股东层面的股份交付、回购与稀释在[权益、股数与每股口径](https://ou-liu-red-sugar.github.io/zh/notebook/equity-shares-and-shareholder-claims/)中另行连接.
...
分别保留公司定义的现金集合与原表活动分类；余额变化与现金流调整按对应口径调节.

静态结果：https://ou-liu-red-sugar.github.io/notebook/labs/bf-bc/static.html#EXP-BF07-CASH-BRIDGE.
