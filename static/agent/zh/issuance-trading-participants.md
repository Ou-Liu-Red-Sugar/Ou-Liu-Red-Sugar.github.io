...
Entry: zh-m02 | Node: M02 | Language: zh | Editorial revision: 2026-09-22

## Teaching instructions
用M02《发行、交易与市场参与者》带我追踪资金和权利. 先通过本篇 reference 包中的公开链接，实际读完 required_readings 指定单元，记录来源、版本、读取范围和支持当前讲解的内容. PDF 表格与公式核对原页. 读取失败时从原机构查找同版材料；仍缺关键单元则指出受影响的任务，补齐后再讲解. 根据一次完整任务诊断我的水平，跳过已掌握的步骤；反馈先给定位提示，再展开解析.
让我按甲、乙、发行人三列，重建国库券发行、转售和到期的现金变化及权利转移；99.80为教学转售价. 再读Reddit招股书的基准发行表，把748M美元总额分到发行人、出售股东、承销费用及其他发行费用，随后与3月25日完成发行的8-K/A记录比较，保留两份材料各自的数量和时点. 换用TreasuryDirect新购持有渠道，要求我依据45天规则判断转售路径. 最后说明发行人名册、DTC参与人和券商客户明细各记录什么. 通过标准是正确区分收款主体、权利持有人和记录机构.
...
```json
{
  ...
  "prompt": "用M02《发行、交易与市场参与者》带我追踪资金和权利. 先通过本篇 reference 包中的公开链接，实际读完 required_readings 指定单元，记录来源、版本、读取范围和支持当前讲解的内容. PDF 表格与公式核对原页. 读取失败时从原机构查找同版材料；仍缺关键单元则指出受影响的任务，补齐后再讲解. 根据一次完整任务诊断我的水平，跳过已掌握的步骤；反馈先给定位提示，再展开解析.\n让我按甲、乙、发行人三列，重建国库券发行、转售和到期的现金变化及权利转移；99.80为教学转售价. 再读Reddit招股书的基准发行表，把748M美元总额分到发行人、出售股东、承销费用及其他发行费用，随后与3月25日完成发行的8-K/A记录比较，保留两份材料各自的数量和时点. 换用TreasuryDirect新购持有渠道，要求我依据45天规则判断转售路径. 最后说明发行人名册、DTC参与人和券商客户明细各记录什么. 通过标准是正确区分收款主体、权利持有人和记录机构.",
  "required_readings": [
    {
      "source_id": "MA-OS17",
...
- [15.401 Finance Theory I — Lecture 7: Equities](https://ocw.mit.edu/courses/15-401-finance-theory-i-fall-2008/1aea40b063cad5a335e980ecf30d84b7_MIT15_401F08_lec07.pdf): 普通股的权利结构，以及发行和已有证券转售的经济关系.
...
- [Reddit, Inc. Final Prospectus — Class A Common Stock](https://www.sec.gov/Archives/edgar/data/1713445/000162828024012380/reddit-final424b4.htm): 基准发行包括公司发行的新股与现有股东出售的股份. 表中金额未计超额配售、承销佣金和其他费用.
