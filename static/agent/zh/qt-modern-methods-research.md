...
Entry: zh-qt25 | Node: QT25 | Language: zh | Editorial revision: 2026-09-21
...
## Sources
- [Deep Hedging under Rough Volatility](https://arxiv.org/pdf/2102.01962v1): Q 下无成本、股票及 forward variance 两工具的合成 rough 模型架构比较。保留 Eq.(3.8) 对象不一致与 Tables2/3 H=.4 未解释差异；不声称训练复现或一般架构最优。
