...
沿股份权利、取得与出售过程、存托和相关交易形式讲解。承接前三篇实际正文。简明版讲清对象、机构、动作、资金去向与用途，条款补充保留在原句的详细版。Reddit 的发行、员工奖励和锁定分别依已核原件说明，不把授予、归属、行权或交付、解禁和实际卖出合成一条普遍流程。SKHY 按每份对应十分之一股韩国普通股，公开存托协议格式不称为最终签署文本。DTC沿用2025-12-11公布的具名方案，不把它转述成当前全面上线状态。AAPLx是Backed发行的追踪凭证，实际权利和分红经济效果按产品条款说明。CME采用美股SAAPL个股期货，每份乘数100股、到期现金结算；每股变动1美元的例子是毛盈亏计算，不是即时报价。Kraken AAPLx永续与苹果股份、AAPLx代币分别辨认，资金费与保证金接回第二篇。期权仅简短回接前篇的交股结算看涨期权。教学案例用于理解机制，不代表用户账户或交易安排。
