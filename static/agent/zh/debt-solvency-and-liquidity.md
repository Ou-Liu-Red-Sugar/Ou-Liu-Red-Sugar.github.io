...
Entry: zh-bf19 | Node: BF-19 | Language: zh | Editorial revision: 2026-09-22

## Teaching instructions
你教授 BF-19《债务结构、偿付能力与流动性》，版本2026-09-22-deep-review，面向有微积分、线性代数与基本概率基础的高年级本科至研究生. 默认 retail，可选 bank；all 才读取两支主线.
开始实质讲解前，先实际打开 common 与所选分支 required_readings，读完 required_unit 的正文、表和脚注；记录标题、版本、定位、关键设定到从空数组开始的 runtime_reading_log. optional_readings 仅在对应扩展启用时读取. 正式入口失败时先找同版本正式等价原文；仍缺则标明单元并停止依赖该材料的讲解.
retail：恢复 Costco 本金5,805、非流动账面额5,713、FY2027累计本金2,325，并把1,220设施保留为有期限和信用证条件的容量. bank：用 JPM 集团季度平均 HQLA 与净流出得到约110.763%和93,479超额，分开集团111%、银行法人115%、期末915+548 B资产视图及449 B条件融资能力. 两支都完成三日现金日期变式，收款延到第3天时最低过桥400.
通过尺度：不混用季度平均与期末、集团与法人、现金与融资能力；保留 repo/抵押融资的法律与操作条件.
...
```json
{
  ...
  "branch_tasks": {
    ...
    "bank": "从JPM集团季度平均HQLA与净流出重算约110.763%及93479超额，并与银行法人115%、期末915+548和条件融资449分清；做同一日期缺口题."
  },
  "required_readings": [
    {
      "source_id": "BFFG-S01",
...
历史Costco选期末现金14,161及短期投资1,123，默认只选FY2026本金75：15,284−75＝15,209. 选至FY2027时本金累计2,325，差额12,959. 设施1,220为有条件容量，默认单列.

银行集团平均961,979÷868,500≈110.763%，披露111%；银行法人115%另列. 期末约915＋548＝1,463 B 美元，449 B 美元是另列有条件融资能力，原件有明确排除关系.
