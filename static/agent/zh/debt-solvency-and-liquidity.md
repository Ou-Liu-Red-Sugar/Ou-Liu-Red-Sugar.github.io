...
Entry: zh-bf19 | Node: BF-19 | Language: zh | Editorial revision: 2026-09-21

## Teaching instructions
你教授BF-19《债务结构、偿付能力与流动性》，版本2026-09-21-review-v3，面对有微积分、线性代数与基本概率基础的高年级本科至研究生. 使用本包同源全文，不另造一套事实.
...
当前分支任务：{"retail": "从Costco完整债务表恢复5805本金、5713非流动账面额和FY2027累计2325；再将教学600收款改到第3天，算中途最低过桥400.", "bank": "从JPM集团季度平均HQLA与净流出重算110.7633%及93479超额，并与银行法人115%、期末915+548和条件融资449分清；做同一日期缺口题."}
...
本篇特有边界：禁止将季度平均HQLA+期末证券拼总额；449能力原文排除关系要如实保留；设施不是无条件现金.
...
```json
{
  ...
  "branch_tasks": {
    "retail": "从Costco完整债务表恢复5805本金、5713非流动账面额和FY2027累计2325；再将教学600收款改到第3天，算中途最低过桥400.",
    "bank": "从JPM集团季度平均HQLA与净流出重算110.7633%及93479超额，并与银行法人115%、期末915+548和条件融资449分清；做同一日期缺口题."
  },
  "required_readings": [
    {
      "source_id": "BFFG-S01",
      "access": {
        "kind": "html_full_text",
        "uri": "https://openstax.org/books/principles-finance/pages/6-3-liquidity-ratios",
        "verified_access_at": "2026-09-21"
      },
      "required_unit": {
        "locator": "§6.3",
        "scope": "全节",
        "purpose": "流动性与偿付共同框架；比率只是入口而非安全结论"
      },
      "supports": "流动性与偿付共同框架；比率只是入口而非安全结论",
      "branch": "common",
      "required_when": "共同或所选行业主线",
      "title": "OpenStax Principles of Finance — Liquidity Ratios",
      "authors": [
        "Julie Dahlquist",
        "Rainford Knight"
      ],
    ...
    },
    {
      ...
      "access": {
        "kind": "html_full_text",
        "uri": "https://openstax.org/books/principles-finance/pages/6-4-solvency-ratios",
        "verified_access_at": "2026-09-21"
      },
      "required_unit": {
        "locator": "§6.4",
        "scope": "全节",
        "purpose": "长期偿付与利息/债务关系；用于共同框架"
      },
      "supports": "长期偿付与利息/债务关系；用于共同框架",
      "branch": "common",
      "required_when": "共同或所选行业主线",
      "title": "OpenStax Principles of Finance — Solvency Ratios",
      "authors": [
        "Julie Dahlquist",
        "Rainford Knight"
      ],
    ...
    },
    {
      ...
      "required_unit": {
        "locator": "Note4；MD&A Bank Credit Facilities；BS现金/短投及完整CFS",
        "scope": "完整债务与maturity表及脚注、设施整段、相关主表",
        "purpose": "恢复本金/账面与有条件资金"
      },
      "supports": "恢复本金/账面与有条件资金",
      "branch": "retail",
      "required_when": "共同或所选行业主线",
  ...
  "optional_readings": [
    {
      ...
      "required_unit": {
        ...
        "scope": "全文",
        "purpose": "历史实际/预计流出与多因素机制"
      },
      "supports": "历史实际/预计流出与多因素机制",
      "branch": "svb",
    ...
    },
    {
      ...
      "required_unit": {
        ...
        "purpose": "SVB应急融资和内部压力条件"
      },
      "supports": "SVB应急融资和内部压力条件",
      "branch": "svb",
      "required_when": "所选扩展启用时",
    ...
    },
    {
      ...
      "access": {
        "kind": "pdf_full_text",
        "uri": "https://www.clevelandfed.org/-/media/project/clevelandfedtenant/clevelandfedsite/events/financial-stability-conferences/2023-papers/matvos-bank-fragility.pdf",
        "verified_access_at": "2026-09-21"
      },
      "required_unit": {
        "locator": "Introduction，§2，§3.1–3.2",
        "scope": "2023-09-28版本完整采用单元",
        "purpose": "资产重估与负债融资研究"
      },
      "supports": "资产重估与负债融资研究",
      "branch": "research-bank",
      "required_when": "所选扩展启用时",
      ...
      "version": "实际采用2023-09-28公开稿；后发表JFE159(2024),103899",
      "retrieved_at": "2026-09-21",
      "id": "BF19-READ-07",
      "activated_by": "research-bank",
      "required_when_selected": true
    }
  ],
  "runtime_reading_log": [],
  "supplied_inputs": {
    ...
    "liquidity_teaching": {
      ...
      "debt_day": 2,
      "observation_days": 3,
      "same_day_order": "当日收款先于付款；非结算制度一般结论",
      "conditions": "已确认一项无条件收款权；只改到账日，不改销售收入/债务本金；负值表示融资前缺口."
    },
    "cost_debt": {
      "source_id": "BFFG-C01",
      "unit": "USD M",
      "as_of": "2025-08-31",
      "cash": 14161,
      "short_investments": 1123,
      "facility_capacity": 1220,
      "maturity_labels": [
        "FY2026",
        "FY2027",
        "FY2028",
      ...
      "unamortized": 17,
      "current_net": 75,
      "noncurrent_carrying": 5713,
      "facility_conditions": [
        "多数设施一年内到期，续期只是管理层意图.",
        "借款余额在期末不重大.",
        "可借金额受未结信用证影响；1220不另擅自扣200.",
        "是否能在所选付款日提款仍须核到期、条件、主体及币种."
      ]
    },
    "tables": {
      "cost_debt": {
        ...
        "source_id": "BFFG-C01",
        "locator": "SEC HTML Note 4—Debt，Long-Term Debt表及脚注",
        "periods": [
          "2025-08-31",
          "2024-09-01"
        ],
        ...
        "rows": [
          {
            "id": "2027a",
            "label_original": "3.000% Senior Notes due May 2027",
            "label_zh": "2027年5月到期3.000%高级票据",
            "values": [
              1000,
              1000
            ],
          ...
          {
            "id": "2027b",
            "label_original": "1.375% Senior Notes due June 2027",
            "label_zh": "2027年6月到期1.375%高级票据",
            "values": [
              1250,
              1250
            ],
          ...
          {
            "id": "2030",
            "label_original": "1.600% Senior Notes due April 2030",
            "label_zh": "2030年4月到期1.600%高级票据",
            "values": [
              1750,
              1750
            ],
          ...
          {
            "id": "2032",
            "label_original": "1.750% Senior Notes due April 2032",
            "label_zh": "2032年4月到期1.750%高级票据",
            "values": [
              1000,
              1000
            ],
          ...
          {
            "id": "other",
            "label_original": "Other long-term debt",
            "label_zh": "其他长期债务",
            "values": [
              805,
              919
          ...
          {
            "id": "principal",
            "label_original": "Total long-term debt",
            "label_zh": "本金合计",
            "values": [
              5805,
              5919
          ...
          {
            "id": "discount",
            "label_original": "Less unamortized debt discounts and issuance costs",
            "label_zh": "减：未摊销折价和发行费用",
            "values": [
              -17,
              -22
            ],
          ...
          {
            "id": "current",
            "label_original": "Less current portion",
            "label_zh": "减：流动部分（原脚注净额口径）",
            "values": [
              -75,
              -103
            ],
        ...
        "notes": [
          "原脚注：流动部分扣除相关未摊销折价及发行费用，列入其他流动负债；不可泛化为流动账面额永远等于未折现本金."
        ]
      },
      "jpm_lcr": {
        "id": "JPM-LCR-Q42025",
  ...
  "required_readings_by_branch": {
    ...
    "bank": [
      ...
      },
      {
        ...
        "required_unit": {
          "locator": "印刷pp100–103／一基物理pp132–135",
          "scope": "Liquidity Risk Management完整单元、所有采用表格与脚注",
          "purpose": "集团/法人、平均/期末及融资渠道区分"
        },
        "supports": "集团/法人、平均/期末及融资渠道区分",
        "branch": "bank",
        "required_when": "共同或所选行业主线",
  ...
  "bibliography": [
    ...
    },
    {
      ...
      "version": "2022",
      "url": "https://openstax.org/books/principles-finance/pages/6-3-liquidity-ratios",
      "locators": [
        "§6.3 全节"
      ]
    },
    {
      ...
      "version": "2022",
      "url": "https://openstax.org/books/principles-finance/pages/6-4-solvency-ratios",
      "locators": [
        "§6.4 全节"
      ]
    },
    {
      ...
      "version": "实际采用2023-09-28公开稿；后发表JFE159(2024),103899",
      "url": "https://www.clevelandfed.org/-/media/project/clevelandfedtenant/clevelandfedsite/events/financial-stability-conferences/2023-papers/matvos-bank-fragility.pdf",
      "locators": [
        "Introduction",
        "§2",
        "§3.1–3.2"
  ...
  "experiment_ids": [
    "EXP-BF19-MATURITY-AND-LIQUIDITY"
  ],
  "input_projection": {
...
共同部分加零售或银行中的一条分支，约需15–20分钟；另一分支和历史案例可随后展开. 金额没有特别说明时均为 M 美元，材料均按文中所列固定期次使用.
...
单位：USD M. 原脚注：流动部分扣除相关未摊销折价及发行费用，列入其他流动负债；不可泛化为流动账面额永远等于未折现本金.
...
单位：USD M. 季度平均；银行法人行与集团行身份不同. 证券使用监管公允价值及haircut口径. 集团排除银行超过独立最低要求且无法转移给非银行关联方的HQLA；金额比值不是逐日监管比率平均的重新计算.
...
年报另有一个期末视图：2025-12-31，未扣监管haircut的期末HQLA约915 B 美元，加其他无抵押可交易证券约548 B 美元，约为1,463 B 美元，对应披露的约1500 B 美元可用现金和证券. 这里没有使用刚才的季度平均961.979 B 美元. [^jpmsources]
...
449 B 美元的原文说明明确排除了已经列在HQLA或其他无抵押证券中的资产所提供的相关借款能力，不能简单说它必然重复. 另一方面，排除了重复也不会让<strong>融资能力</strong>自动变成<strong>已经在账户中的现金</strong>. 正确的做法是保留它的渠道与可动用条件，问抵押物能否按时动员，而不是把三行加成一个没有条件的“总现金”. [^jpmsources]

期末客户存款2,559,320 M 美元，其中估计未保险存款1,558,600 M 美元，占60.8990%. 这个比例提醒我们继续读客户类型、账户用途和资金集中程度；它不是未来挤兑概率. 稳定性需要由存款行为和业务关系解释，不由“未保险”三个字单独决定. [^jpmdeposits]
...
961,979÷868,500＝110.7633%，超额93,479. 111%为集团季度平均披露，115%为银行法人同期平均，915 B 美元为期末未扣监管折扣的HQLA近似值. 可查的条件例如：相应法人是否已向融资渠道交付合格抵押物、额度是否可提用、操作和结算能否赶上现金需求. 不能用“能借”代替“付款账户已到账”.
...
美联储复盘记载，SVB在2023-03-08宣布包括证券出售和拟增资的资产负债调整；3月9日存款流出超过40 B 美元，管理层预计次日再流出100 B 美元，银行于3月10日关闭. 后一个数是当时的预期，不是已经实现的另一笔流出. 复盘同时记录了未保险存款集中、风险治理、内部压力测试及应急融资缺陷. [^svb]
...
银行三组不相加：集团平均961,979÷868,500＝110.7633%，披露111%；银行法人115%另列. 期末约915＋548＝1,463 B 美元，449 B 美元是另列有条件融资能力，原件有明确排除关系.
...
[
  {
    "id": "EXP-BF19-MATURITY-AND-LIQUIDITY",
    "title": "债务、流动性与日期缺口",
    "anchor": "bf19-calendar",
    "description": "Costco本金/期末资源对照与JPM口径分层；独立3天教学收款日可变.",
    "inputs": {
    ...
    "algorithm": "maturity、bank、stress；按日排序，同日收款先于付款.",
    "boundaries": "不推算未来公司现金，不生成挤兑概率或安全阈值；设施需显式确认条件.",
    "outputs": {
      "default_branch": "retail",
      "maturity": {
        "identity": "analyst_arithmetic_not_forecast",
        "snapshot_date": "2025-08-31",
        "through": "FY2026",
        "selected_assets": 15284,
        "selected_principal": 75,
        "difference": 15209,
        "conditional_capacity": 0,
        "conditional_scenario_difference": null,
        "conditions": [
          "多数设施一年内到期，续期只是管理层意图.",
          "借款余额在期末不重大.",
          "可借金额受未结信用证影响；1220不另擅自扣200.",
      ...
      "bank": {
        ...
        "average_amount_ratio_pct": 110.76327000575705,
        "period_end_asset_sum_approx_bn": 1463,
        "uninsured_share_pct": 60.89898879389838,
        "total_unconditional_liquidity": null,
        "run_probability": null
      },
      "stress": [
        {
          "identity": "hypothetical_contract",
          "receipt_day": 1,
          "initial_cash": 1000,
          "events": [
            {
    ...
    "static_equivalent": "## 债务与流动性：默认与日期变式\n\n历史Costco选期末现金14,161及短期投资1,123，默认只选FY2026本金75：15,284−75＝15,209. 选至FY2027时本金累计2,325，差额12,959. 设施默认不纳入；它是有条件容量1,220，而非现金.\n\n银行三组不相加：集团平均961,979÷868,500＝110.7633%，披露111%；银行法人115%另列. 期末约915＋548＝1,463 B 美元，449 B 美元是另列有条件融资能力，原件有明确排除关系.\n\n独立教学合同：期初1000；第1天付900，第2天还500；600收款日可变. 同日先收后付，负数为融资前缺口.\n\n| 收款日 | 第1天末 | 第2天末 | 第3天末 | 最低现金 | 最低过桥 |\n|---|---|---|---|---|---|\n| 1 | 700 | 200 | 200 | 200 | 0 |\n| 2 | 100 | 200 | 200 | 100 | 0 |\n| 3 | 100 | -400 | 200 | -400 | 400 |\n\n同一3天终值200不消除中间付款约束；教学变式不改变任何公司历史披露.\n",
    "source_id_aliases": {
      "BFFG-C01": "BF-S-COST-FY2025-SEC",
      "BFFG-C02": "BF-S-JPM-FY2025",
      "BFFG-C04": "BBC-C01",
    ...
    "local_url": "/notebook/labs/bf-fg/interactions.html?experiment=EXP-BF19-MATURITY-AND-LIQUIDITY"
  }
]
```
...
- [Monetary Tightening and U.S. Bank Fragility in 2023: Mark-to-Market Losses and Uninsured Depositor Runs?](https://www.clevelandfed.org/-/media/project/clevelandfedtenant/clevelandfedsite/events/financial-stability-conferences/2023-papers/matvos-bank-fragility.pdf): 资产重估与存款融资机制的研究选读；不导入总体估计或JPM运行概率.
- [OpenStax Principles of Finance — Liquidity Ratios](https://openstax.org/books/principles-finance/pages/6-3-liquidity-ratios): 稳定教学结构，不代替具体公司合同、会计范围或统一安全阈值.
- [OpenStax Principles of Finance — Solvency Ratios](https://openstax.org/books/principles-finance/pages/6-4-solvency-ratios): 稳定教学结构，不代替具体公司合同、会计范围或统一安全阈值.
...
[
  ...
  },
  {
    ...
    "scope": "仅正文/所选扩展实际使用范围",
    "at_section": "bf19-maturity"
  },
  {
    "from": "bf19-bank-layers",
    "relation": "supported_by",
    "to": "BF-S-JPM-FY2025",
  ...
  },
  {
    ...
    "relation": "supported_by",
    "to": "BFFG-R01",
    "reason": "资产重估与存款融资机制的研究选读；不导入总体估计或JPM运行概率.",
    "locator": [
      "Introduction",
      "§2",
      "§3.1–3.2"
  ...
  },
  {
    ...
    "at_section": "bf19-calendar"
  },
  {
    "from": "bf19-calendar",
    "relation": "illustrated_by",
    "to": "EXP-BF19-MATURITY-AND-LIQUIDITY",
    "at_section": "bf19-calendar",
    "reason": "Costco本金/期末资源对照与JPM口径分层；独立3天教学收款日可变.",
    "conditions": "不推算未来公司现金，不生成挤兑概率或安全阈值；设施需显式确认条件."
  }
]
```
...
拆一份企业财报: step 11/14
选择零售或银行，分开期间承受力、指定日期需求和可操作资金.
资金时点核清之后，再看用来比较经营的盈利口径如何调整.
Next: [盈利质量、调整口径与比较](https://ou-liu-red-sugar.github.io/zh/notebook/earnings-quality-adjustments-and-comparability/)
