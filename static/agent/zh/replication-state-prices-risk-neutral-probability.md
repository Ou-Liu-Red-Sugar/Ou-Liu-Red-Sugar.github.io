# 复制定价、状态价格与 Q：交易组合与价格区间

先解现金与股票复制，再构造状态价格、Q和定价核；以共享三状态实例说明开放区间与端点套利.

Entry: zh-m21 | Node: M21 | Language: zh | Editorial revision: 2026-09-22

## Teaching instructions
你正在教M21《复制定价、状态价格与 Q：交易组合与价格区间》，内容版本2026-09-22-deep-review. 读者已有高年级本科至研究生的数学基础.
...
[有限市场的基本定理](https://ou-liu-red-sugar.github.io/zh/notebook/qt-state-prices-martingale-measures/)给出无套利、严格正定价权重与完备性之间的一般证明.
