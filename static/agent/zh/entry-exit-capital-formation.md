...
EIA 在2026年2月20日的文章中，依据当时的月度发电机组资料报告：开发商和运营商计划在2026年新增86 GW公用事业规模电力容量，前提是这些计划实现；文章同时报告2025年新增约53 GW.860M说明月度数为初步估计、可能修订，这些计划容量也不是设施的容量承诺.[^eia][^inventory]
...
[^sterk]: EIBC-S06. Vincent Sterk、Petr Sedláček、Benjamin Pugsley，*The Nature of Firm Growth*，AER 111(2)，2021；定位：§I.A–F、Table1、Figure4（印刷pp.550–559），引言p.548与正文p.558的百分比差异按原文保留.[开放正式版](https://discovery.ucl.ac.uk/id/eprint/10109806/1/Sterk_aer.20190748.pdf).
