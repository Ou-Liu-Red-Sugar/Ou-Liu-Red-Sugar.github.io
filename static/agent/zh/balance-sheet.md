...
按零售或银行业务阅读完整资产负债表，追查关键附注，并将两期余额与期间现金、股东权益连接起来.

Entry: zh-balance-sheet | Node: BF-05 | Language: zh | Editorial revision: 2026-09-22

## Teaching instructions
面向具有微积分、线性代数、基本概率与证明阅读能力的高年级本科生至研究生，材料版本2026-09-22-coherence. 围绕 BF-05《资产负债表：全表结构、附注与行业差异》开展教学. 读者选择零售Costco或银行JPM；未选择时默认零售. 共同部分加一条行业分支构成本次任务，另一分支另读；银行的衍生品净额为可选展开.

开始实质教学前，实际读取共同必读单元：
FASB Concepts Statement 8 Chapter 4（2021-12）
https://storage.fasb.org/Concepts_Statement_8-Chapter_4-Elements.pdf
读取E16–E70，取得资产、负债、权益的定义及完整特征单元，并保持“概念定义”和具体计量规则的区别.
...
读取本节，取得报表共同结构、流动/非流动分类和交易联系；其中的简化教学措辞不替代所选公司的现行披露.
...
该PDF资产负债表位于印刷p.37／物理p.43. 切换版本时重新核对表头、数值和附注标题，不能沿用SEC版页码推定读取范围.

选择银行分支时，再实际读取：
https://www.jpmorganchase.com/content/dam/jpmc/jpmorgan-chase-and-co/investor-relations/documents/annualreport-2025.pdf
MD&A Introduction印刷p.46／物理p.78；完整资产负债表及VIE脚注p.167／物理p.199；完整现金流量表p.169／物理p.201及MD&A Cash flows analysis p.58；Note 10 pp.228–229；Note 12 Loan accounting framework pp.236–238以及Loan portfolio p.239的完整构成表与脚注；Note 17 p.277全文. PDF表格查看原页.
只有读者选择“衍生品总额、表内净额与担保品”展开时，才把Note 5 pp.207–209加入当前必读范围.

每项阅读记录标题、版本、实际范围、取得方式，以及它支持当前教学的哪一步. 运行时读取日志初始为空，只记录本次实际取得的单元；书目列表、链接打开页、目录或摘要都不能替代要求的正文. 读取失败时先找同机构的等价全文或本包已核等价单元；仍缺失就报告缺少的具体单元.

材料齐备后，从共同结构直接建立三项区分：报告日余额、期间利润、期间现金. “交易、利润与现金”展开使用正文的完整教学设定；读者打开时，走完期初、赊购100、赊销150并结转100、付款、收款，说明每一步怎样改变资产、负债、权益、利润和经营现金. 默认现金100/权益100；现金为0且先付款时显示资金缺口100，不生成未声明透支.

随后呈现所选公司的完整原表，保留英文原行、中文解释、两期、负数、小计、单位、括注和无金额披露. 从业务关系选择需要追的主表行，再沿附注解释构成和计量，最后回到现金或普通股归属. 小计和其明细只能在同一汇总中使用一次；VIE附注也不能再次加入集团总额.

零售分支沿商品存货和应付账款进入采购—销售关系. 让读者计算选定余额由−774到−1,667，再与现金流调整559+404=963对照；893与963之间的70保持未归因. 应收按实际交易对手继续拆分. 随后解释递延会员费、会员奖励、物业设备、使用权资产和租赁负债为何出现在这家零售企业的表内，并用Note 5把租赁义务4,147放回原表. 最后用完整现金桥接回14,161，并区分现金增加、存货/应付调整和权益两期变化各自回答的问题.

银行分支沿客户存款等资金来源和贷款、证券等资金运用进入. 先区分资产方Deposits with banks与负债方Deposits，再回接贷款三类、贷款损失准备、AFS/HTM和44.1 B非现金重分类. 准备比率默认匹配retained贷款；切换全部贷款作分母时同时改写口径，不能把该比率的变化直接解释成风险改善. 如选择净额展开，再按Note 5区分衍生品应收总额606,382、表内净应收57,777和考虑担保品后的28,886. 最后从总股东权益扣除优先股得到普通股权益，复算流通股与每股账面值，并用p.169的现金流量表把343,338接回`Cash and due from banks + Deposits with banks`.

所选分支完成后再使用迁移题. 通过标准是：读者能够从完整主表定位业务相关的权利和义务，追到附注核计量与构成，完成必要计算，并说明报告日余额、期间现金和权益归属各自支持什么结论. 根据计算和解释中出现的具体缺口反馈，已掌握的关系直接继承.
...
```json
{
  ...
  "learning_task": "给定一份两期资产负债表，选择与业务有关的权利和义务，沿主表与附注解释余额怎样形成，再用现金流或权益归属核对两期变化.",
  "prompt": "面向具有微积分、线性代数、基本概率与证明阅读能力的高年级本科生至研究生，材料版本2026-09-22-coherence. 围绕 BF-05《资产负债表：全表结构、附注与行业差异》开展教学. 读者选择零售Costco或银行JPM；未选择时默认零售. 共同部分加一条行业分支构成本次任务，另一分支另读；银行的衍生品净额为可选展开.\n\n开始实质教学前，实际读取共同必读单元：\nFASB Concepts Statement 8 Chapter 4（2021-12）\nhttps://storage.fasb.org/Concepts_Statement_8-Chapter_4-Elements.pdf\n读取E16–E70，取得资产、负债、权益的定义及完整特征单元，并保持“概念定义”和具体计量规则的区别.\nOpenStax Principles of Accounting Vol.1（2019）§2.2：\nhttps://openstax.org/books/principles-financial-accounting/pages/2-2-define-explain-and-provide-examples-of-current-and-noncurrent-assets-current-and-noncurrent-liabilities-equity-revenues-and-expenses\n读取本节，取得报表共同结构、流动/非流动分类和交易联系；其中的简化教学措辞不替代所选公司的现行披露.\n\n选择零售分支时，再实际读取：\nhttps://www.sec.gov/Archives/edgar/data/909832/000090983225000101/cost-20250831.htm\nItem 1 General及Membership相关完整单元；完整资产负债表p.39、现金流量表p.41；Note 1 Basis of Presentation、Fiscal Year、Reclassification、Cash and Cash Equivalents、Receivables Net、Merchandise Inventories、Revenue Recognition；Note 5 pp.53–54全文.\n备选同公司PDF：\nhttps://s201.q4cdn.com/287523651/files/doc_financials/2025/ar/COST-Annual-Report-2025.pdf\n该PDF资产负债表位于印刷p.37／物理p.43. 切换版本时重新核对表头、数值和附注标题，不能沿用SEC版页码推定读取范围.\n\n选择银行分支时，再实际读取：\nhttps://www.jpmorganchase.com/content/dam/jpmc/jpmorgan-chase-and-co/investor-relations/documents/annualreport-2025.pdf\nMD&A Introduction印刷p.46／物理p.78；完整资产负债表及VIE脚注p.167／物理p.199；完整现金流量表p.169／物理p.201及MD&A Cash flows analysis p.58；Note 10 pp.228–229；Note 12 Loan accounting framework pp.236–238以及Loan portfolio p.239的完整构成表与脚注；Note 17 p.277全文. PDF表格查看原页.\n只有读者选择“衍生品总额、表内净额与担保品”展开时，才把Note 5 pp.207–209加入当前必读范围.\n\n每项阅读记录标题、版本、实际范围、取得方式，以及它支持当前教学的哪一步. 运行时读取日志初始为空，只记录本次实际取得的单元；书目列表、链接打开页、目录或摘要都不能替代要求的正文. 读取失败时先找同机构的等价全文或本包已核等价单元；仍缺失就报告缺少的具体单元.\n\n材料齐备后，从共同结构直接建立三项区分：报告日余额、期间利润、期间现金. “交易、利润与现金”展开使用正文的完整教学设定；读者打开时，走完期初、赊购100、赊销150并结转100、付款、收款，说明每一步怎样改变资产、负债、权益、利润和经营现金. 默认现金100/权益100；现金为0且先付款时显示资金缺口100，不生成未声明透支.\n\n随后呈现所选公司的完整原表，保留英文原行、中文解释、两期、负数、小计、单位、括注和无金额披露. 从业务关系选择需要追的主表行，再沿附注解释构成和计量，最后回到现金或普通股归属. 小计和其明细只能在同一汇总中使用一次；VIE附注也不能再次加入集团总额.\n\n零售分支沿商品存货和应付账款进入采购—销售关系. 让读者计算选定余额由−774到−1,667，再与现金流调整559+404=963对照；893与963之间的70保持未归因. 应收按实际交易对手继续拆分. 随后解释递延会员费、会员奖励、物业设备、使用权资产和租赁负债为何出现在这家零售企业的表内，并用Note 5把租赁义务4,147放回原表. 最后用完整现金桥接回14,161，并区分现金增加、存货/应付调整和权益两期变化各自回答的问题.\n\n银行分支沿客户存款等资金来源和贷款、证券等资金运用进入. 先区分资产方Deposits with banks与负债方Deposits，再回接贷款三类、贷款损失准备、AFS/HTM和44.1 B非现金重分类. 准备比率默认匹配retained贷款；切换全部贷款作分母时同时改写口径，不能把该比率的变化直接解释成风险改善. 如选择净额展开，再按Note 5区分衍生品应收总额606,382、表内净应收57,777和考虑担保品后的28,886. 最后从总股东权益扣除优先股得到普通股权益，复算流通股与每股账面值，并用p.169的现金流量表把343,338接回`Cash and due from banks + Deposits with banks`.\n\n所选分支完成后再使用迁移题. 通过标准是：读者能够从完整主表定位业务相关的权利和义务，追到附注核计量与构成，完成必要计算，并说明报告日余额、期间现金和权益归属各自支持什么结论. 根据计算和解释中出现的具体缺口反馈，已掌握的关系直接继承.",
  ...
  "required_readings_by_branch": {
    ...
    "BS-BANKING": [
      ...
      },
      {
        ...
        "required_unit": {
          "locator": "MD&A Introduction印刷p.46／物理p.78；完整资产负债表及VIE脚注p.167／物理p.199；完整现金流量表p.169／物理p.201及MD&A Cash flows analysis p.58；Note 10 pp.228–229；Note 12 Loan accounting framework pp.236–238以及Loan portfolio p.239的完整构成表与脚注；Note 17 p.277全文. PDF表格查看原页.",
          ...
          "purpose": "银行完整原表、VIE脚注、贷款与存款计量，以及现金流与主表现金集合的核对"
        },
        "supports": "MD&A Introduction印刷p.46／物理p.78；完整资产负债表及VIE脚注p.167／物理p.199；完整现金流量表p.169／物理p.201及MD&A Cash flows analysis p.58；Note 10 pp.228–229；Note 12 Loan accounting framework pp.236–238以及Loan portfolio p.239的完整构成表与脚注；Note 17 p.277全文. PDF表格查看原页.",
        "fallback_source_ids": [],
  ...
  "optional_readings": [
    ...
    },
    {
      ...
      "required_unit": {
        "locator": "选择衍生品净额展开时读取Note 5 pp.207–209的完整表格、脚注及净额列报政策.",
        "scope": "选择衍生品净额展开时读取Note 5 pp.207–209的完整表格、脚注及净额列报政策.",
        "purpose": "衍生品总额、表内抵销和表外担保品的区别"
      },
      "supports": "选择衍生品净额展开时读取Note 5 pp.207–209的完整表格、脚注及净额列报政策.",
      "fallback_source_ids": [],
      "role": "extension",
      "required_when_selected": true,
      "for_branch": "BS-BANKING"
...
默认期初现金100，五步结果见正文bf05-events交易演示. 期初现金0且先付款时，资金缺口100；先收款则最终现金50、权益50、利润50、经营现金净额50.
