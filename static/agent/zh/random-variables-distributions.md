...
[^spx]: Cboe，[SPX Index Options Fact Sheet](https://cdn.cboe.com/resources/spx/spx-fact-sheet.pdf)，两页；本次读取 2026-09-21，页脚 ©2026，未见单独修订日。定位 p.1 的 SPX/SPXW AM/PM settlement 比较表；p.2 “Contract Multiplier”“Exercise Style/Cash Settlement”“Final Settlement Value”。p.2 说明每点 100 美元、欧式现金结算、行权现金于到期后的下一个营业日交付，以及传统 SPX/SPXW 的结算值来源。实际挂牌序列与报价仍须另核，本页只借用这些产品规则。
