...
把资源、生产、交付与成本约束连接起来，分别用电力与工程机械识别承重瓶颈、解除约束后的传播路径和时间差.

Entry: zh-ei04 | Node: EI-04 | Language: zh | Editorial revision: 2026-09-22

## Teaching instructions
读者为有充分数学背景的高年级本科生至研究生. 教授EI-04《供给、成本与有效产能》，2026-09-22-deep-review.
先确认电力或工程机械分支；目标是重建资源—生产—交付过程，定位承重约束及时间差.
...
记录实际标题、期次、完整取得的页/节及其支持的定义或观察. 当前分支必读齐全后再教；同会话同版已完整读取可复用；不能取得原件则列明具体缺口.

电力诊断：解释2 GW／8 GWh在六小时恒定出力下的能量限制，保留期初满电、无充电及损耗条件. 制造诊断：按Census新订单构造重建381，说明取消与修改已进入净额；再用一般企业台账分析独立调整项. 推导价格接受者的约束最优产量，保留本期固定成本不可避免条件. 用所选行业迁移题和固定成本变化题检验资源、生产、交付与时间关系.
...
```json
{
  ...
  "export_mode": "public",
  "audience": "微积分与基本约束优化",
  "learning_task": "把资源、生产、交付与成本约束连接起来，分别用电力与工程机械识别承重瓶颈、解除约束后的传播路径和时间差.",
  "body_source": "body_markdown",
  "prompt": "读者为有充分数学背景的高年级本科生至研究生. 教授EI-04《供给、成本与有效产能》，2026-09-22-deep-review.\n先确认电力或工程机械分支；目标是重建资源—生产—交付过程，定位承重约束及时间差.\n\n先实际取得：\n1. CORE The Economy 1.0 §7.3全文及图7.6–7.8：\n   https://books.core-econ.org/the-economy-v1/book/text/07.html\n   https://www.core-econ.org/wp-content/uploads/2021/04/the-economy-unit-7-pdf.pdf\n   读取成本定义、图注与上下文，不采用教材数值作本篇工厂参数.\n2. 电力分支：IEA Electricity2025印刷pp57–60及p61首段，读到该事件单元结束：\n   https://iea.blob.core.windows.net/assets/7c671ef6-2947-4e87-beea-af0e1288e1d7/Electricity2025.pdf\n   查看p57、58、60图及图注. 确认2024年事件、两种纵轴和可用容量定义.\n3. 制造分支：Census M3 May2026 Full Report，CB26-104 M3-2(26)-05，\n   2026-07-02发布. 历史入口：\n   https://www.census.gov/manufacturing/m3/historical_data/pressreleases/prel/2026/may26prel.pdf\n   必须实际读第1页身份、第3–4页说明和第6–9页工程机械行及表注.\n   同时实际读 Census M3 Methodology 的 Estimation（PDF pp.2–3）与 Seasonal Adjustment Methodology（pp.3–4），包括新订单构造和取消/修改影响的定义：\n   https://www.census.gov/manufacturing/m3/Web_Methodology.pdf\n   固定原件若未取得，就明确报告缺口；不得以滚动“current”文件替代历史期次.\n\n记录实际标题、期次、完整取得的页/节及其支持的定义或观察. 当前分支必读齐全后再教；同会话同版已完整读取可复用；不能取得原件则列明具体缺口.\n\n电力诊断：解释2 GW／8 GWh在六小时恒定出力下的能量限制，保留期初满电、无充电及损耗条件. 制造诊断：按Census新订单构造重建381，说明取消与修改已进入净额；再用一般企业台账分析独立调整项. 推导价格接受者的约束最优产量，保留本期固定成本不可避免条件. 用所选行业迁移题和固定成本变化题检验资源、生产、交付与时间关系.",
  ...
  "common_required_readings": [
    {
      ...
      "required_unit": {
        "locator": "§7.3全文及Figures7.6–7.8，含成本定义、图注与上下文",
        "scope": "§7.3全文及Figures7.6–7.8，含成本定义、图注与上下文",
      ...
      "alternative_access": [
        {
          ...
          "equivalent_scope": "§7.3全文及Figures7.6–7.8，含成本定义、图注与上下文"
        }
      ]
    }
  ],
...
教学电力桥取负荷60 GW、风光15 GW、常规容量50 GW、停运5 GW，可用常规容量45 GW，恰好满足负荷. 风光降至5 GW且进口5 GW时，储能前缺口5 GW. 储能功率2 GW、电量8 GWh，期初充满、期间无充电及损耗，连续6小时恒定出力上限为 $4/3$ GW，剩余缺口 $11/3$ GW，需其他资源或需求调整补足. 缩短为4小时，可出力2 GW，缺口3 GW.

价格接受者成本为 $C(q)=F+cq+kq^2/2$，$F$ 为本期不可避免成本，$k>0$，$0\le q\le K$. 取 $F=100,c=10,k=1,K=20,P=25$，最优产量15，总成本362.5、收入375、利润12.5. 价格降到20，产量10、利润−50；停产利润为−100.

Census May 2026工程机械季调新订单满足 $4879=4498+(11595-11214)$，统计构造已纳入取消及修改影响. 存货另增66，期末存货／当月出货约2.37.

一般企业台账可另设净调整 $A$：$B_1=B_0+N-S+A$. 教学输入 $B_0=11214,N=4879,S=4498$，$A=0$ 得11595，$A=-100$ 得11495. 若从总新订单5000出发，扣取消121得净额4879.
...
[
  ...
  },
  {
    ...
    "reason": "历史时段供给与相邻市场条件"
  },
  {
    "from": "zh-ei04",
    "relation": "illustrated_by",
    "to": "case-ei-us-construction-machinery-202605",
    "reason": "订单、出货和存货的不同观察环节"
  },
  {
    "from": "zh-ei04",
    "relation": "illustrated_by",
    "to": "EXP-EI-CAPACITY-01",
    "reason": "功率/能量约束与短期成本的教学计算"
  },
  {
    "from": "zh-ei04",
...
Next: [竞争、差异化与利润分配](https://ou-liu-red-sugar.github.io/zh/notebook/competition-differentiation-profit/)
