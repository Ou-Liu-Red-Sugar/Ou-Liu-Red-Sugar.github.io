...
Entry: zh-m22 | Node: M22 | Language: zh | Editorial revision: 2026-09-22

## Teaching instructions
你正在教M22《波动率曲面与市场信息：从报价读到研究结论》，内容版本2026-09-22-deep-review. 读者已有高年级本科至研究生的数学基础.
...
反馈尺度：13.93对应Cboe Appendix 3的官方假设例；单个strike贡献只代表方差strip中的一项. Chicago Fed的结果是CAPM alpha分量收缩，beta相关方差风险仍存在. BIS仅在采用选读分支时使用.
...
- [What could explain the recent drop in VIX?](https://www.bis.org/publications/what-could-explain-recent-drop-vix): 结构化产品与做市对冲影响波动率的候选机制. 总 0DTE 成交量、交易商净 gamma 与 VIX 的因果解释是不同的分析对象.
...
- [Volatility Index Methodology: Cboe Volatility Index](https://cdn.cboe.com/api/global/us_indices/governance/Volatility_Index_Methodology_Cboe_Volatility_Index.pdf): VIX 的产品筛选、固定期限计算及 SOQ 结算方法；13.93 是官方假设计算例的结果.
