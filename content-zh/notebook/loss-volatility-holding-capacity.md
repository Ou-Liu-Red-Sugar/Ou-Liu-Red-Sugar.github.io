{
  "title": "亏损、波动与持有能力",
  "description": "从 KO 的修复与 FISV 的失利出发，结合行业比较、Risk–Reward、量价观察和资金安排，理解持有与退出。",
  "layout": "entry",
  "notebookid": "zh-loss-volatility-holding-capacity",
  "math": true,
  "body_format": "markdown",
  "translationKey": "zh-loss-volatility-holding-capacity"
}
