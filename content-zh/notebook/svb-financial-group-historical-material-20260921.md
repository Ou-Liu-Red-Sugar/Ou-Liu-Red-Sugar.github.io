{
  "title": "SVB Financial Group（历史报告对象）：具名材料记录",
  "description": "观察报告所述内部压力测试与融资操作准备；不把历史复盘当现行法条。",
  "layout": "entry",
  "notebookid": "zh-record-svb-financial-group-historical-20260921",
  "math": true,
  "body_format": "markdown",
  "translationKey": "zh-record-svb-financial-group-historical-20260921"
}
