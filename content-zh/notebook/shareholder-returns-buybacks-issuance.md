{
  "title": "股东回报：分红、回购与增发",
  "description": "从 AAPL 的分红与回购、Alphabet（GOOGL／GOOG）的权益融资出发，理解市场买盘、税务时点、净股数变化和每股所得。",
  "layout": "entry",
  "notebookid": "zh-shareholder-returns-buybacks-issuance",
  "math": true,
  "body_format": "markdown",
  "translationKey": "zh-shareholder-returns-buybacks-issuance"
}
