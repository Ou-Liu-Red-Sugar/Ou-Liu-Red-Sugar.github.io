...
用约18分钟，完成一件事：从一份真实合约读出未来义务，再把数量、报价、损益和今天需要准备的现金分开。需要先会<a class="inline-ref" href="/zh/notebook/financial-claims/" data-reference="zh-financial-claims">识别金融权利的主体、条件与单位<span aria-hidden="true"> ↗</span></a>；这里不预先要求期货交易经验。
