...
用约20分钟，重建两条价格路径的现金账，并找到一处“终点虽然盈利，中途却不能继续”的资金缺口。先修是<a class="inline-ref" href="/zh/notebook/forward-futures-contracts/" data-reference="zh-m10">按方向和合约乘数算价格变动损益<span aria-hidden="true"> ↗</span></a>；本篇不要求了解清算所的完整风险模型。
