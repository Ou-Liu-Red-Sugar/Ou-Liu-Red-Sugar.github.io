...
这不是要求收集所有指标，而是把“利率影响很大”改成一项可核查陈述：**哪个合同或客户选择，在什么时候、通过什么变量改变了经营路径？** <a class="inline-ref" href="/zh/notebook/research-corporate-cash-rate-transmission/" data-reference="zh-ei18">企业现金与利率传导研究<span aria-hidden="true"> ↗</span></a>将进一步讨论怎样用企业数据检验其中一部分关系。
