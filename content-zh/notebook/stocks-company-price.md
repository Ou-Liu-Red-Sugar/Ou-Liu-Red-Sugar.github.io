{
  "title": "股票、公司与股价",
  "description": "从买公司的一部分出发，结合 Apple（AAPL）、NVIDIA（NVDA）与 SK hynix（000660／SKHY）的实例，理解基本面、股份、股价与市值。",
  "layout": "entry",
  "notebookid": "zh-stocks-company-price",
  "math": true,
  "body_format": "markdown",
  "translationKey": "zh-stocks-company-price"
}
