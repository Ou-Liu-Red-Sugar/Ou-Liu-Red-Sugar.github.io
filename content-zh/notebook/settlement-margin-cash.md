{
  "title": "投资组合、保证金与对冲策略",
  "description": "从业务与 Risk-Reward 建立组合，理解 beta 对冲的范围，由 Agent 结合市场状态比较期货、Put 与减持，再把保证金、盯市和交收接到现金安排。",
  "layout": "entry",
  "notebookid": "zh-settlement-margin-cash",
  "math": true,
  "body_format": "markdown",
  "translationKey": "zh-settlement-margin-cash"
}
