...
用约20分钟，从一份企业披露写出互换两条利息腿，再判断它何时能抵销贷款的浮动利息。可以从<a class="inline-ref" href="/zh/notebook/financial-claims/" data-reference="zh-financial-claims">金融权利与义务<span aria-hidden="true"> ↗</span></a>直接进入；不要求先学原油期货。这里只在需要时调用利率现金流和<a class="inline-ref" href="/zh/notebook/clearing-settlement-collateral/" data-reference="zh-m04">履约担保<span aria-hidden="true"> ↗</span></a>的语言。
